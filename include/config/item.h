...
#define I_EXP_SHARE_FLAG        FLAG_UNUSED 0x264    // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
