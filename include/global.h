...
struct SaveBlock2
{
    ...
    /*0x14*/ u16 optionsTextSpeed:3; // OPTIONS_TEXT_SPEED_[SLOW/MID/FAST]
             ...
             u16 optionsBattleSceneOff:1; // whether battle animations are disabled
              ...
              u16 optionsStartMenuPalette:4; // which color palette for the start menu
             //u16 padding2;
...
struct Bag
{
    ...
    struct ItemSlot letters[BAG_LETTERS_COUNT];
...
#endif
        u8 registeredItemLastSelected:4; //max 16 items for tx_registered_items
