...
struct __attribute__((packed)) BoxPokemon
{
    ...
    // Bitfield words (6 words = 24 bytes, total 64 bytes)
    // Word 1: species, held item, flags
    u32 species:11;
    u32 heldItem:10;
    u32 isBadEgg:1;
    u32 hasSpecies:1;
    ...
    u32 experience:21;
    u32 language:3;
    u32 hiddenNatureModifier:5;
    u32 championRibbon:1;
    u32 winningRibbon:1;
    u32 victoryRibbon:1;

    // Word 3: moves 1-2, pokerus, friendship, artist ribbon
    u32 move1:11;
    u32 move2:11;
    u32 pokerusType:1;
    u32 friendship:8;
    ...
    // Word 4: moves 3-4, ppBonuses, effort ribbon
    u32 move3:11;
    u32 move4:11;
    u32 ppBonuses:8;
    u32 effortRibbon:1;
    u32 unusedBitfield4:1;

    // Word 5: IVs, shiny modifier
    u32 hpIV:5;
    u32 attackIV:5;
    u32 defenseIV:5;
    u32 speedIV:5;
    ...
    u32 spDefenseIV:5;
    u32 shinyModifier:1;
    u32 unusedBitfield5:1;

    // Word 6: met data, pokeball, contest ribbons
    u32 metLevel:7;
    u32 metGame:3;
    u32 otGender:1;
    u32 pokeball:6;
