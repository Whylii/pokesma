...
{
    COMPOUND_STRING("Der beste Kandidat für den Titel!"), // Highest potential
    COMPOUND_STRING("Ein sicherer Finalist."),
    COMPOUND_STRING("Ein Anwärter auf die Top 3."),
    COMPOUND_STRING("Ein Kandidat für den ersten Platz."),
    COMPOUND_STRING("Ein Team mit Top-Potenzial."),
    COMPOUND_STRING("Das Überraschungsteam dieses Turniers."),
    COMPOUND_STRING("Ein überdurchschnittliches Team."),
    COMPOUND_STRING("Das durchschnittliche Team des Turniers."),
    COMPOUND_STRING("Ein Team mit durchschnittlichem Potenzial."),
    COMPOUND_STRING("Ein unterdurchschnittliches Team."),
    COMPOUND_STRING("Ein Team auf der Suche nach dem ersten Sieg."),
    COMPOUND_STRING("Ein Sieg würde dieses Team stolz machen."),
    COMPOUND_STRING("Insgesamt ein schwaches Team."),
    COMPOUND_STRING("Ein Team mit sehr geringem Potenzial."),
    COMPOUND_STRING("Ein Team, das wohl nicht gewinnen wird."),
    COMPOUND_STRING("Das Team mit den geringsten Chancen."), // Lowest potential
    COMPOUND_STRING("Der perfekte, unschlagbare Superstar!"), // Dome Ace Tucker
};
...
{
    [DOME_BATTLE_STYLE_RISKY]           = COMPOUND_STRING("Riskieren manchmal eine totale Katastrophe."),
    [DOME_BATTLE_STYLE_STALL]           = COMPOUND_STRING("Geschickt im Aushalten langer Kämpfe."),
    [DOME_BATTLE_STYLE_VARIED]          = COMPOUND_STRING("Variiert Taktiken je nach Gegner."),
    [DOME_BATTLE_STYLE_COMBO_HIGH]      = COMPOUND_STRING("Hat ein starkes Siegesmuster."),
    [DOME_BATTLE_STYLE_RARE_MOVES]      = COMPOUND_STRING("Setzt gelegentlich sehr seltene Attacken ein."),  // Seems like the text for these two was swapped
    [DOME_BATTLE_STYLE_RARE_MOVE]       = COMPOUND_STRING("Setzt überraschende und verwirrende Attacken ein."), //
    [DOME_BATTLE_STYLE_HP]              = COMPOUND_STRING("Behält im Kampf ständig die KP im Auge."),
    [DOME_BATTLE_STYLE_STORE_POWER]     = COMPOUND_STRING("Gut darin, Kraft zu speichern und zu entfesseln."),
    [DOME_BATTLE_STYLE_ENFEEBLE_LOW]    = COMPOUND_STRING("Geschickt im Schwächen von Gegnern."),
    [DOME_BATTLE_STYLE_LUCK]            = COMPOUND_STRING("Bevorzugt Taktiken, die auf Glück beruhen."),
    [DOME_BATTLE_STYLE_REGAL]           = COMPOUND_STRING("Greift mit königlicher Aura an."),
    [DOME_BATTLE_STYLE_LOW_PP]          = COMPOUND_STRING("Greift mit starken, AP-armen Attacken an."),
    [DOME_BATTLE_STYLE_STATUS_ATK]      = COMPOUND_STRING("Schwächt Gegner erst, greift dann an."),
    [DOME_BATTLE_STYLE_ENDURE]          = COMPOUND_STRING("Kämpft, während er alle Angriffe aushält."),
    [DOME_BATTLE_STYLE_STATUS]          = COMPOUND_STRING("Geschickt darin, Gegner zu verunsichern."),
    [DOME_BATTLE_STYLE_STRAIGHTFORWARD] = COMPOUND_STRING("Setzt starke und direkte Attacken ein."),
    [DOME_BATTLE_STYLE_AGGRESSIVE]      = COMPOUND_STRING("Setzt aggressive starke Attacken ein."),
    [DOME_BATTLE_STYLE_DEF]             = COMPOUND_STRING("Kämpft mit geschicktem Ausweichen."),
    [DOME_BATTLE_STYLE_ENFEEBLE_HIGH]   = COMPOUND_STRING("Geschickt im Einsatz beunruhigender Attacken."),
    [DOME_BATTLE_STYLE_POPULAR_POWER]   = COMPOUND_STRING("Setzt viele beliebte Attacken ein."),
    [DOME_BATTLE_STYLE_COMBO_LOW]       = COMPOUND_STRING("Hat Attacken für starke Kombos."),
    [DOME_BATTLE_STYLE_ACCURATE]        = COMPOUND_STRING("Setzt Attacken mit hoher Trefferquote ein."),
    [DOME_BATTLE_STYLE_POWERFUL]        = COMPOUND_STRING("Setzt aggressive spektakuläre Attacken ein."),
    [DOME_BATTLE_STYLE_ATK_OVER_DEF]    = COMPOUND_STRING("Bevorzugt Angriff vor Verteidigung."),
    [DOME_BATTLE_STYLE_DEF_OVER_ATK]    = COMPOUND_STRING("Bevorzugt Verteidigung vor Angriff."),
    [DOME_BATTLE_STYLE_POPULAR_STRONG]  = COMPOUND_STRING("Greift schnell mit starken Attacken an."),
    [DOME_BATTLE_STYLE_EFFECTS]         = COMPOUND_STRING("Setzt oft Attacken mit Zusatzeffekten ein."),
    [DOME_BATTLE_STYLE_BALANCED]        = COMPOUND_STRING("Setzt eine ausgewogene Mischung ein."),
    [DOME_BATTLE_STYLE_UNUSED1]         = COMPOUND_STRING("Dies ist eine Beispielnachricht 1."),
    [DOME_BATTLE_STYLE_UNUSED2]         = COMPOUND_STRING("Dies ist eine Beispielnachricht 2."),
    [DOME_BATTLE_STYLE_UNUSED3]         = COMPOUND_STRING("Dies ist eine Beispielnachricht 3."),
    [DOME_BATTLE_STYLE_UNUSED4]         = COMPOUND_STRING("Dies ist eine Beispielnachricht 4."),
};
...
{
    COMPOUND_STRING("Bevorzugt KP und Angriff."),              // DOME_TEXT_TWO_GOOD_STATS and DOME_TEXT_HP start here
    COMPOUND_STRING("Bevorzugt KP und Verteidigung."),
    COMPOUND_STRING("Bevorzugt KP und Initiative."),
    COMPOUND_STRING("Bevorzugt KP und Sp. Angriff."),
    COMPOUND_STRING("Bevorzugt KP und Sp. Verteidigung."),
    COMPOUND_STRING("Bevorzugt Angriff und Verteidigung."),         // DOME_TEXT_ATK starts here
    COMPOUND_STRING("Bevorzugt Angriff und Initiative."),
    COMPOUND_STRING("Bevorzugt Angriff und Sp. Angriff."),
    COMPOUND_STRING("Bevorzugt Angriff und Sp. Verteidigung."),
    COMPOUND_STRING("Bevorzugt Verteidigung und Initiative."),          // DOME_TEXT_DEF starts here
    COMPOUND_STRING("Bevorzugt Verteidigung und Sp. Angriff."),
    COMPOUND_STRING("Bevorzugt Verteidigung und Sp. Verteidigung."),
    COMPOUND_STRING("Bevorzugt Initiative und Sp. Angriff."),       // DOME_TEXT_SPEED starts here
    COMPOUND_STRING("Bevorzugt Initiative und Sp. Verteidigung."),
    COMPOUND_STRING("Bevorzugt Sp. Angriff und Sp. Verteidigung."), // DOME_TEXT_SPATK starts here
    COMPOUND_STRING("Bevorzugt KP."),                         // DOME_TEXT_ONE_GOOD_STAT starts here
    COMPOUND_STRING("Bevorzugt Angriff."),
    COMPOUND_STRING("Bevorzugt Verteidigung."),
    COMPOUND_STRING("Bevorzugt Initiative."),
    COMPOUND_STRING("Bevorzugt Sp. Angriff."),
    COMPOUND_STRING("Bevorzugt Sp. Verteidigung."),
    ...
    COMPOUND_STRING("Vernachlässigt KP und Sp. Verteidigung."),
    COMPOUND_STRING("Vernachlässigt Angriff und Verteidigung."),
    COMPOUND_STRING("Vernachlässigt Angriff und Initiative."),
    COMPOUND_STRING("Vernachlässigt Angriff und Sp. Angriff."),
    COMPOUND_STRING("Vernachlässigt Angriff und Sp. Verteidigung."),
    COMPOUND_STRING("Vernachlässigt Verteidigung und Initiative."),
    COMPOUND_STRING("Vernachlässigt Verteidigung und Sp. Angriff."),
    COMPOUND_STRING("Vernachlässigt Verteidigung und Sp. Verteidigung."),
    COMPOUND_STRING("Vernachlässigt Initiative und Sp. Angriff."),
    COMPOUND_STRING("Vernachlässigt Initiative und Sp. Verteidigung."),
    COMPOUND_STRING("Vernachlässigt Sp. Angriff und Sp. Verteidigung."),
    ...
    COMPOUND_STRING("Vernachlässigt Sp. Angriff."),
    COMPOUND_STRING("Vernachlässigt Sp. Verteidigung."),
    [DOME_TEXT_WELL_BALANCED] = COMPOUND_STRING("Zieht Pokémon auf ausgeglichene Weise auf."),
};
...
static const u8 *const sBattleDomeWinTexts[] =
{
    ...
    [DOME_TEXT_CHAMP_USING_MOVE] = COMPOUND_STRING("{STR_VAR_1} wird Champion!"),
    [DOME_TEXT_WON_ON_FORFEIT]   = COMPOUND_STRING("{STR_VAR_1} gewinnt kampflos!"),
    [DOME_TEXT_CHAMP_ON_FORFEIT] = COMPOUND_STRING("{STR_VAR_1} gewinnt eindeutig kampflos!"),
    [DOME_TEXT_WON_NO_MOVES]     = COMPOUND_STRING("{STR_VAR_1} gewinnt ohne eine Attacke!"),
    [DOME_TEXT_CHAMP_NO_MOVES]   = COMPOUND_STRING("{STR_VAR_1} gewinnt eindeutig ohne Attacken!"),
};
