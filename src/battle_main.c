...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_AQUA_ADMIN] = { _("Aqua-Vorstand"), 10 },
    ...
    [TRAINER_CLASS_TUBER_F] = { _("Nichtschwimmer"), 1 },
    [TRAINER_CLASS_TUBER_M] = { _("Nichtschwimmer"), 1 },
    ...
    [TRAINER_CLASS_SR_AND_JR] = { _("Vater und Sohn."), 4 },
    ...
    [TRAINER_CLASS_DRAGON_TAMER] = { _("Drachenzähmer"), 12 },
    [TRAINER_CLASS_NINJA_BOY] = { _("Ninja-Junge"), 3 },
    [TRAINER_CLASS_BATTLE_GIRL] = { _("Kämpferin"), 6 },
    [TRAINER_CLASS_PARASOL_LADY] = { _("Schirmlady"), 10 },
    ...
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("Magma-Vorstand"), 10 },
