...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNGAINEDEXP]                        = COMPOUND_STRING("{B_BUFF1} erhält{B_BUFF2} {B_BUFF3} E.-Punkte!\p"),
    ...
    [STRINGID_STATHARSHLY]                          = COMPOUND_STRING("steigt stark!"),
    [STRINGID_ATTACKERSSTATROSE]                    = COMPOUND_STRING("{B_BUFF1} von {B_ATK_NAME_WITH_PREFIX} {B_BUFF2} steigt."),
    [STRINGID_DEFENDERSSTATROSE]                    = gText_DefendersStatRose,
    [STRINGID_SCRIPTINGSTATROSE]                    = COMPOUND_STRING("{B_BUFF1} von {B_SCR_NAME_WITH_PREFIX} {B_BUFF2} steigt."),
    [STRINGID_ATTACKERSSTATFELL]                    = COMPOUND_STRING("{B_BUFF1} von {B_ATK_NAME_WITH_PREFIX} {B_BUFF2} sinkt."),
    [STRINGID_DEFENDERSSTATFELL]                    = COMPOUND_STRING("{B_BUFF1} von {B_DEF_NAME_WITH_PREFIX} {B_BUFF2} sinkt."),
    [STRINGID_CRITICALHIT]                          = COMPOUND_STRING("Ein Volltreffer!"),
    [STRINGID_ONEHITKO]                             = COMPOUND_STRING("Ein K.O.-Treffer!"),
    [STRINGID_123POOF]                              = COMPOUND_STRING("Eins…{PAUSE 10}zwei…{PAUSE 10}und…{PAUSE 10}{PAUSE 10}{PLAY_SE SE_BALL_BOUNCE_1}ta-da!\p"),
