...
static const u8 sText_TwoWildPkmnAppeared[] = _("Oh! Ein wildes {B_OPPONENT_MON2_NAME} und\nein wildes {B_OPPONENT_MON1_NAME} erscheinen!\p");
static const u8 sText_GhostAppearedCantId[] = _("Ein Geist erscheint!\pOh oh!\nDer Geist kann nicht\l identifiziert werden!\p");
...
static const u8 sText_LinkTrainer2SentOutPkmn2[] = _("{B_LINK_OPPONENT2_NAME} schickt \n{B_OPPONENT_MON2_NAME} in den Kampf!");
static const u8 sText_LinkTrainerSentOutTwoPkmn[] = _("{B_LINK_OPPONENT1_NAME} schickt\n{B_OPPONENT_MON1_NAME} und {B_OPPONENT_MON2_NAME}\lin den Kampf!");
static const u8 sText_TwoLinkTrainersSentOutPkmn[] = _("{B_LINK_OPPONENT1_NAME} schickt\n{B_LINK_OPPONENT_MON1_NAME} in den Kampf! {B_LINK_OPPONENT2_NAME} schickt\n{B_LINK_OPPONENT_MON2_NAME}\lin den Kampf!");
...
static const u8 sText_LinkPartnerSentOutPkmn1GoPkmn[] = _("{B_LINK_PARTNER_NAME} schickt\n{B_LINK_PLAYER_MON1_NAME} in den Kampf!\lLos! {B_LINK_PLAYER_MON2_NAME}!");
static const u8 sText_LinkPartnerSentOutPkmn2GoPkmn[] = _("{B_LINK_PARTNER_NAME} schickt\n{B_LINK_PLAYER_MON2_NAME}!\lLos! {B_LINK_PLAYER_MON1_NAME}!");
static const u8 sText_LinkPartnerSentOutPkmn1[] = _("{B_LINK_PARTNER_NAME} schickt\n{B_LINK_PLAYER_MON1_NAME} in den Kampf!");
static const u8 sText_LinkPartnerSentOutPkmn2[] = _("{B_LINK_PARTNER_NAME} schickt\n{B_LINK_PLAYER_MON2_NAME} in den Kampf!");
static const u8 sText_LinkPartnerWithdrewPkmn1[] = _("{B_LINK_PARTNER_NAME} ruft\n{B_LINK_PLAYER_MON1_NAME} zurück!");
static const u8 sText_LinkPartnerWithdrewPkmn2[] = _("{B_LINK_PARTNER_NAME} ruft\n{B_LINK_PLAYER_MON2_NAME} zurück!");
static const u8 sText_PkmnSwitchOut[] = _("{B_BUFF1}, komm zurück!"); //currently unused, I believe its used for when you switch on a pokemon in shift mode
...
static const u8 sText_PkmnGoodComeBack[] = _("Gut, {B_BUFF1}!\nKomm zurück!");
static const u8 sText_Trainer1WithdrewPkmn[] = _("{B_BUFF1} wurde\nvon {B_TRAINER1_CLASS} {B_TRAINER1_NAME}\lzurückgerufen!");
static const u8 sText_Trainer2WithdrewPkmn[] = _("{B_BUFF1} wurde\n von {B_TRAINER2_NAME_WITH_CLASS}\lzurückgerufen!");
...
const u8 gText_severely[] = _("schwere ");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PLAYERWHITEOUT2_WILD]                 = COMPOUND_STRING("Du warst in Panik und hast\n¥{B_BUFF1} verloren…"),
    [STRINGID_PLAYERWHITEOUT2_TRAINER]              = COMPOUND_STRING("Du hast ¥{B_BUFF1} an den Gewinner gezahlt…"),
    [STRINGID_PLAYERWHITEOUT3]                      = COMPOUND_STRING("Du wurdest von der Niederlage überwältigt!"),
    ...
    [STRINGID_PKMNPOISONEDBY]                       = COMPOUND_STRING("{B_BUFF1} von\n{B_SCR_NAME_WITH_PREFIX2} vergiftete\l{B_EFF_NAME_WITH_PREFIX}!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNENERGYDRAINED]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} wurde Energie\nentzogen!"),
    [STRINGID_PKMNWASBURNED]                        = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} brennt!"),
    [STRINGID_PKMNBURNEDBY]                         = COMPOUND_STRING("{B_BUFF1} von\n{B_SCR_NAME_WITH_PREFIX} verbrennt\l{B_EFF_NAME_WITH_PREFIX2}!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNFROZENBY]                         = COMPOUND_STRING("{B_BUFF1} von\n{B_SCR_NAME_WITH_PREFIX} ließ \l{B_EFF_NAME_WITH_PREFIX2} einfrieren!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNRAISEDSPDEF]                      = COMPOUND_STRING("Das Lichtschild hat das Team\nvon {B_ATK_TEAM2} gegen Spezial-Attacken\lstärker gemacht!"),
    [STRINGID_PKMNRAISEDDEF]                        = COMPOUND_STRING("Reflektor von {B_ATK_TEAM2}\nerhöht die Verteidigung"),
    [STRINGID_PKMNCOVEREDBYVEIL]                    = COMPOUND_STRING("Team von {B_ATK_TEAM1} wird von\neinem Schleier umhüllt!"),
    [STRINGID_PKMNUSEDSAFEGUARD]                    = COMPOUND_STRING("Team von {B_SCR_NAME_WITH_PREFIX} wird durch\nBodyguard geschützt!"),
    [STRINGID_PKMNSAFEGUARDEXPIRED]                 = COMPOUND_STRING("Bodyguard von{B_ATK_TEAM1}\nlässt nach!"),
