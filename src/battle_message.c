...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNRAISEDSPDEF] = COMPOUND_STRING("Lichtschild um {B_ATK_TEAM2} Team stärkt gegen Spezial-Attacken!"),
    [STRINGID_PKMNRAISEDDEF] = COMPOUND_STRING("Reflektor um {B_ATK_TEAM2} Team stärkt gegen physische Attacken!"),
    [STRINGID_PKMNAURORAVEIL] = COMPOUND_STRING("Auroraschleier um {B_ATK_TEAM2} erhöht die Verteidigung und Sp. Ver!"),
    ...
    [STRINGID_PKMNAVOIDEDATTACK] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} ist ausgewichen!"),
    [STRINGID_BATTLERAVOIDEDATTACK] = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} ist ausgewichen!"),
    ...
    [STRINGID_PKMNSTAYEDAWAKEUSING] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} hält sich mit {B_DEF_ABILITY} wach!"),
    ...
    [STRINGID_PKMNGOTFREE] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} befreit sich von {B_BUFF1}!"),
    [STRINGID_PKMNSHEDLEECHSEED] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} befreit sich von Egelsamen!"),
    [STRINGID_PKMNBLEWAWAYSPIKES] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} bläst die Stacheln weg!"), // Not in gen 5+
    ...
    [STRINGID_PKMNPREVENTSUSAGE] = COMPOUND_STRING("{B_DEF_ABILITY} von {B_DEF_NAME_WITH_PREFIX} hindert {B_ATK_NAME_WITH_PREFIX2} daran, {B_CURRENT_MOVE} einzusetzen!"), //not in gen 5+, ability popup
    [STRINGID_PKMNRESTOREDHPUSING] = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} füllt einige KP auf!"),
    [STRINGID_PKMNCHANGEDTYPEWITH] = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} wird zu einem {B_BUFF1}-Typ!"),
    ...
    [STRINGID_PKMNPREVENTSCONFUSIONWITH] = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} verhindert Verwirrung!"),
    [STRINGID_PKMNRAISEDFIREPOWERWITH] = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} erhöht die Kraft des Feuers!"),
    [STRINGID_PKMNANCHORSITSELFWITH] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} haftet mit seinen Saugnäpfen fest am Boden!"),
    [STRINGID_PKMNPREVENTSSTATLOSSWITH] = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} verhindert Statusveränderungen!"),
    [STRINGID_PKMNHURTSWITH] = COMPOUND_STRING("{B_BUFF1} von {B_DEF_NAME_WITH_PREFIX2} verletzt {B_ATK_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNTRACED] = COMPOUND_STRING("Erfassen kopiert die Fähigkeit {B_BUFF2}!"),
    ...
    [STRINGID_THREWPOKEBLOCKATPKMN] = COMPOUND_STRING("{B_PLAYER_NAME} wirft {B_OPPONENT_MON1_NAME} einen Pokériegel zu!"), //safari
    ...
    [STRINGID_PKMNSITEMCUREDPROBLEM] = COMPOUND_STRING("{B_LAST_ITEM} von {B_SCR_NAME_WITH_PREFIX} heilt sein Problem mit {B_BUFF1}!"), // Not in Gen 5+
    ...
    [STRINGID_PKMNSXRESTOREDHPALITTLE2] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} füllt einige KP auf!"),
    ...
    [STRINGID_PKMNSXPREVENTSYLOSS] = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} verhindert den Verlust von {B_BUFF1}!"),
    [STRINGID_PKMNSXINFATUATEDY] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX2} ist verliebt!"),
    [STRINGID_PKMNSXMADEYINEFFECTIVE] = COMPOUND_STRING("Item vob {B_SCR_NAME_WITH_PREFIX} kann nicht entfernt werden!"),
    ...
    [STRINGID_ITEMSCANTBEUSEDNOW] = COMPOUND_STRING("Hier können Items nicht eingesetzt werden.{PAUSE 64}"), // Not present in Gen 5+
    [STRINGID_USINGITEMSTATOFPKMNROSE] = COMPOUND_STRING("{B_LAST_ITEM}: {B_BUFF1} von {B_SCR_NAME_WITH_PREFIX2} wird {B_BUFF2} erhöht!"),
    [STRINGID_USINGITEMSTATOFPKMNFELL] = COMPOUND_STRING("{B_LAST_ITEM}: {B_BUFF1} von {B_SCR_NAME_WITH_PREFIX2} wird {B_BUFF2} gesenkt!"), // This string does not exist in Gen 5+. Used to print more info that's otherwise obscured such as using Room Service
    ...
    [STRINGID_PKMNSXTOOKATTACK] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} übernimmt den Angriff!"),
    ...
    [STRINGID_PKMNSITEMNORMALIZEDSTATUS] = COMPOUND_STRING("{B_LAST_ITEM} von {B_SCR_NAME_WITH_PREFIX} normalisierte seine Statuswerte!"), // Not in Gen 5+
    ...
    [STRINGID_PKMNSXMADEITINEFFECTIVE] = COMPOUND_STRING("Item von {B_SCR_NAME_WITH_PREFIX} kann nicht entfernt werden!"),
    ...
    [STRINGID_PKMNSXWOREOFF] = COMPOUND_STRING("{B_BUFF1} um {B_ATK_TEAM2} lässt nach!"),
    ...
    [STRINGID_BUFFERENDS] = COMPOUND_STRING("{B_BUFF1} um {B_SCR_NAME_WITH_PREFIX2} lässt nach!"),
    ...
    [STRINGID_TARGETABILITYSTATRAISE] = COMPOUND_STRING("{B_DEF_ABILITY} von {B_DEF_NAME_WITH_PREFIX} erhöht {B_BUFF1} {B_BUFF2}!"), // Not in Gen 5+
    [STRINGID_STATWASMAXEDOUT] = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} maximiert {B_BUFF1}!"),
    [STRINGID_ATTACKERABILITYSTATRAISE] = COMPOUND_STRING("{B_ATK_ABILITY} von {B_ATK_NAME_WITH_PREFIX} erhöht {B_BUFF1} {B_BUFF2}!"), // Not in Gen 5+
    [STRINGID_POISONHEALHPUP] = COMPOUND_STRING("Die Vergiftung heilt {B_ATK_NAME_WITH_PREFIX2} ein wenig!"), // Not in Gen 5+
    ...
    [STRINGID_SOLARPOWERHPDROP] = COMPOUND_STRING("{B_ATK_ABILITY} von {B_ATK_NAME_WITH_PREFIX} schadet!"), // Not in Gen 5+
    ...
    [STRINGID_ICEBODYHPGAIN] = COMPOUND_STRING("{B_ATK_ABILITY} von {B_ATK_NAME_WITH_PREFIX} füllt wenige KP auf!"), // Not in Gen 5+
    ...
    [STRINGID_ATTACKERACQUIREDABILITY] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} erhält {B_ATK_ABILITY}!"), // Not in Gen 5+
    [STRINGID_TARGETABILITYSTATLOWER] = COMPOUND_STRING("{B_DEF_ABILITY} von {B_DEF_NAME_WITH_PREFIX} senkt seine {B_BUFF1} {B_BUFF2}!"), // Not in Gen 5+
    ...
    [STRINGID_PKMNSWILLPERISHIN3TURNS] = COMPOUND_STRING("Beide Pokémon vergehen in 3 Runden!"),
    ...
    [STRINGID_ITEMCUREDSPECIESSTATUS] = COMPOUND_STRING("Statusproblem von {B_BUFF1} wurde geheilt!"), // Not in Gen 5+
    ...
    [STRINGID_PKMNTERASTALLIZEDINTO] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} hat sich in den Typ {B_BUFF1} terastallisiert!"), // Does not exist, meant to mimic form change strings
    ...
    [STRINGID_SUPEREFFECTIVETWOFOES] = COMPOUND_STRING("Es ist sehr effektiv gegen {B_DEF_NAME} und {B_DEF_PARTNER_NAME}!"),
    [STRINGID_NOTVERYEFFECTIVETWOFOES] = COMPOUND_STRING("Es ist nicht sehr effektiv gegen {B_DEF_NAME} und {B_DEF_PARTNER_NAME}!"),
    ...
    [STRINGID_POWERCONSTRUCTTRANSFORM] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} verwandelte sich in seine Finale Form!"),
    ...
    [STRINGID_SILPHSCOPEUNVEILED] = COMPOUND_STRING(
    "Das Silph Scope enthüllt die\n"
    "Identität des Geistes!"),
    [STRINGID_GHOSTWASMAROWAK] = COMPOUND_STRING(
    "Der Geist war Knogga!\p\n"
    ""),
    [STRINGID_TRAINER1MON1COMEBACK] = COMPOUND_STRING("{B_TRAINER1_NAME}: {B_OPPONENT_MON1_NAME}, komm zurück!"),
    [STRINGID_THREWROCK] = COMPOUND_STRING(
    "{B_PLAYER_NAME} wirft einen Stein\n"
    "auf {B_OPPONENT_MON1_NAME}!"),
    [STRINGID_THREWBAIT] = COMPOUND_STRING(
    "{B_PLAYER_NAME} wirft einen Köder\n"
    "auf {B_OPPONENT_MON1_NAME}!"),
    ...
    [STRINGID_REFLECTWOREOFF] = COMPOUND_STRING("Reflektor um {B_DEF_TEAM2} lässt nach!"),
    [STRINGID_LIGHTSCREENWOREOFF] = COMPOUND_STRING("Lichtschild um {B_DEF_TEAM2} lässt nach!"),
    [STRINGID_AURORAVEILWOREOFF] = COMPOUND_STRING("Auroraschleier um {B_DEF_TEAM2} lässt nach!"),
...
const u8 gText_SafariZoneMenu[] = _("Ball{CLEAR_TO 56}Pokériegel\nNäher gehen{CLEAR_TO 56}Flucht");
