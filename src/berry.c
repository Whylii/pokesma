...
const struct Berry gBerries[NUM_BERRIES + 1] =
{
    ...
    [BERRY_ID_CHERI] =
    {
        .info = {
            ...
            .description2 = COMPOUND_STRING("Die helle, rote Beere ist sehr scharf."),
    ...
    [BERRY_ID_CHESTO] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("Die dicke Schale und das Fruchtfleisch sind"),
            .description2 = COMPOUND_STRING("sehr zäh. Sie schmeckt durchweg trocken."),
            .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
            .spicy = 0,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_PECHA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("Sehr süß und lecker. Auch sehr"),
            .description2 = COMPOUND_STRING("zart, mit Vorsicht zu behandeln."),
            .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 10,
    ...
    [BERRY_ID_RAWST] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("Wenn die Blätter lang und lockig werden,"),
            .description2 = COMPOUND_STRING("scheint die Beere sehr bitter zu werden."),
            .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_ASPEAR] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("Die harte Beere ist dicht und"),
            .description2 = COMPOUND_STRING("saftig. Sie ist ziemlich sauer."),
            .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_LEPPA] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("Wächst langsamer als Amrenabeeren."),
            .description2 = COMPOUND_STRING("Je kleiner die Beere, desto schmackhafter."),
    ...
    [BERRY_ID_ORAN] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("Eine eigenartige Beere mit gemischten Aromen."),
            .description2 = COMPOUND_STRING("Beeren wachsen in einem halben Tag."),
    ...
    [BERRY_ID_PERSIM] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("Liebt Sonnenlicht. Die Farbe der Beere"),
            .description2 = COMPOUND_STRING("wird bei Sonneneinstrahlung kräftig."),
            .growthDuration = GROWTH_DURATION(12, 16, 24, 24, 16, 24),
            .spicy = 10,
            .dry = 10,
            .sweet = 10,
    ...
    [BERRY_ID_LUM] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("Wächst langsam. Bei liebevoller Pflege"),
            .description2 = COMPOUND_STRING("kann sie zwei Beeren tragen."),
    ...
    [BERRY_ID_SITRUS] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("Mit der Sinelbeere verwandt. Sie"),
    ...
    [BERRY_ID_FIGY] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("Die Beere, die angebissen aussieht,"),
            .description2 = COMPOUND_STRING("steckt voller scharfer Substanzen."),
    ...
    [BERRY_ID_WIKI] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 15),
            .minYield = YIELD_RATE(2, 1, 3, 3),
            .description1 = COMPOUND_STRING("Die Beere soll klumpig geworden sein,"),
            .description2 = COMPOUND_STRING("damit Pokémon sie besser greifen können."),
            .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
            .spicy = 0,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_MAGO] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 15),
            .minYield = YIELD_RATE(2, 1, 3, 3),
            .description1 = COMPOUND_STRING("Die Beere wird beim Wachsen rundlich."),
            .description2 = COMPOUND_STRING("Je runder, desto süßer und leckerer."),
            .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 10,
    ...
    [BERRY_ID_AGUAV] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 15),
            .minYield = YIELD_RATE(2, 1, 3, 3),
            .description1 = COMPOUND_STRING("Die Blüte ist zart. Sie haat die"),
            .description2 = COMPOUND_STRING("Fähigkeit, ohne Licht zu wachsen."),
            .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_IAPAPA] =
    {
        .info = {
            ...
            .description2 = COMPOUND_STRING("Sie braucht mindestens einen Tag zum Wachsen."),
            .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_RAZZ] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("Die rote Beere schmeckt leicht scharf."),
            .description2 = COMPOUND_STRING("Sie wächst schnell in nur vier Stunden."),
    ...
    [BERRY_ID_BLUK] =
    {
        .info = {
            ...
            .description2 = COMPOUND_STRING("sie färbt den Mund schwarz."),
            .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
            .spicy = 0,
            .dry = 10,
            .sweet = 10,
    ...
    [BERRY_ID_NANAB] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 10, 15, 20),
            .minYield = YIELD_RATE(3, 2, 3, 4),
            .description1 = COMPOUND_STRING("Diese Beere war die siebte, die"),
            .description2 = COMPOUND_STRING("die Welt entdeckte. Sie ist süß."),
            .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 10,
    ...
    [BERRY_ID_WEPEAR] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 10, 15, 20),
            .minYield = YIELD_RATE(3, 2, 3, 4),
            .description1 = COMPOUND_STRING("Die Blüte ist klein und weiß. Sie hat"),
            .description2 = COMPOUND_STRING("ein Gleichgewicht aus bitter und sauer."),
            .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_PINAP] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 10, 15, 20),
            .minYield = YIELD_RATE(3, 2, 3, 4),
            .description1 = COMPOUND_STRING("Empfindlich gegen Wind und Kälte."),
            .description2 = COMPOUND_STRING("Die Frucht ist scharf, die Schale sauer."),
            .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
            .spicy = 10,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_POMEG] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("Egal wie viel man gießt,"),
    ...
    [BERRY_ID_KELPSY] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 5, 20, 26),
            .minYield = YIELD_RATE(2, 1, 1, 2),
            .description1 = COMPOUND_STRING("Eine seltene Sorte, die wie eine Wurzel geformt."),
            .description2 = COMPOUND_STRING("ist. Bildet eine sehr große Blüte."),
            .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
            .spicy = 0,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_QUALOT] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 5, 20, 26),
            .minYield = YIELD_RATE(2, 1, 1, 2),
            .description1 = COMPOUND_STRING("Liebt Wasser. Wächst stark, selbst bei"),
    ...
    [BERRY_ID_HONDEW] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 5, 20, 26),
            .minYield = YIELD_RATE(2, 1, 1, 2),
            .description1 = COMPOUND_STRING("Eine sehr wertvolle Beere,"),
            .description2 = COMPOUND_STRING("selten. Sie ist sehr lecker."),
            .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
            .spicy = 10,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_GREPA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 5, 20, 26),
            .minYield = YIELD_RATE(2, 1, 1, 2),
            .description1 = COMPOUND_STRING("Trotz ihrer Zartheit und runden Form"),
    ...
    [BERRY_ID_TAMATO] =
    {
        .info = {
            ...
            .description2 = COMPOUND_STRING("Sie braucht Zeit zum Wachsen."),
            .growthDuration = GROWTH_DURATION(24, 32, 48, 48, 32, 48),
            .spicy = 20,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_CORNN] =
    {
        .info = {
            ...
            .minYield = YIELD_RATE(2, 2, 3, 3),
            .description1 = COMPOUND_STRING("Eine Beere aus alten Zeiten. Kann nur"),
            .description2 = COMPOUND_STRING("wachsen, wenn man sie in Mengen pflanzt."),
    ...
    [BERRY_ID_MAGOST] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(4, 10, 15, 15),
            .minYield = YIELD_RATE(2, 2, 3, 3),
            .description1 = COMPOUND_STRING("Eine Beere, von der man sagt, dass sie"),
            .description2 = COMPOUND_STRING("einen fein ausgewogenen Geschmack hat."),
            .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 20,
    ...
    [BERRY_ID_RABUTA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(4, 10, 15, 15),
            .minYield = YIELD_RATE(2, 2, 3, 3),
            .description1 = COMPOUND_STRING("Eine seltene Sorte, mit"),
            .description2 = COMPOUND_STRING("Haaren. Sie ist recht bitter."),
            .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_NOMEL] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(4, 10, 15, 15),
            .minYield = YIELD_RATE(2, 2, 3, 3),
            .description1 = COMPOUND_STRING("Ziemlich sauer. Schon ein Biss und"),
            .description2 = COMPOUND_STRING("man kann drei Tage lang nichts schmecken."),
            .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
            .spicy = 10,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_SPELON] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("Die leuchtend rote Beere ist sehr scharf."),
            .description2 = COMPOUND_STRING("Ihre Warzen sondern eine scharfe Substanz ab."),
    ...
    [BERRY_ID_PAMTRE] =
    {
        .info = {
            ...
            .description2 = COMPOUND_STRING("Sie wächst wohl woanders."),
            .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
            .spicy = 0,
            .dry = 40,
            .sweet = 10,
    ...
    [BERRY_ID_WATMEL] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 15, 15, 15),
            .minYield = YIELD_RATE(1, 2, 3, 3),
            .description1 = COMPOUND_STRING("Eine riesige Beere, über 50"),
            .description2 = COMPOUND_STRING("cm groß. Außergewöhnlich süß."),
            .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 40,
    ...
    [BERRY_ID_DURIN] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 15, 15, 15),
            .minYield = YIELD_RATE(1, 3, 3, 3),
            .description1 = COMPOUND_STRING("Schon beim Anblick bitter. Noch"),
            .description2 = COMPOUND_STRING("niemand hat sie roh gegessen."),
            .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_BELUE] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 15, 15, 15),
            .minYield = YIELD_RATE(1, 2, 3, 3),
            .description1 = COMPOUND_STRING("Sie ist glänzend und sieht lecker aus, aber"),
            .description2 = COMPOUND_STRING("sie ist furchtbar sauer. Braucht Zeit zum Wachsen."),
            .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
            .spicy = 10,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_OCCA] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("Wuchs einst in den Tropen,"),
            .description2 = COMPOUND_STRING("hat sie eine intensive Schärfe."),
    ...
    [BERRY_ID_PASSHO] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("Ihr Fruchtfleisch ist übersät mit vielen"),
            .description2 = COMPOUND_STRING("Bläschen, die sie im Wasser halten."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 15,
            .sweet = 0,
    ...
    [BERRY_ID_WACAN] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("Die Energie von Blitzen lässt"),
            .description2 = COMPOUND_STRING("die Beere groß und reichhaltig wachsen."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 0,
            .sweet = 15,
    ...
    [BERRY_ID_RINDO] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("Diese Beere hat einen gemüseartigen Geschmack,"),
            .description2 = COMPOUND_STRING("und ist reich an gesundheitsfördernden Ballaststoffen."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 10,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_YACHE] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("Diese Beere hat einen erfrischend trockenen,"),
            .description2 = COMPOUND_STRING("sauren Geschmack. Schmeckt gekühlt besser."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_CHOPLE] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("Enthält einen Stoff der Hitze."),
            .description2 = COMPOUND_STRING("Kann sogar ein kaltes Herz entflammen."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 15,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_KEBIA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("Außen strahlend grün, innen"),
            .description2 = COMPOUND_STRING("ist sie voller schwarzem Fruchtfleisch."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 15,
            .sweet = 0,
    ...
    [BERRY_ID_SHUCA] =
    {
        .info = {
            ...
            .description2 = COMPOUND_STRING("herben und duftenden Biss."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 10,
            .dry = 0,
            .sweet = 15,
    ...
    [BERRY_ID_COBA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("Diese Beere soll eine Kreuzung aus"),
            .description2 = COMPOUND_STRING("zwei von weit her gewehten Beeren sein."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_PAYAPA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("Spürt menschliche Gefühle, schwillt an"),
            .description2 = COMPOUND_STRING("und rundet sich, wenn sich jemand nähert."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 0,
            .sweet = 10,
    ...
    [BERRY_ID_TANGA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("Sie bildet eine Blüte, die Käfer-Pokémon"),
            .description2 = COMPOUND_STRING("mit ihren fädigen Blütenblättern lieben."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 20,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_CHARTI] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("Wird wegen ihres trockenen Geschmacks"),
            .description2 = COMPOUND_STRING("geschätzt. Wird manchmal roh gegessen."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 10,
            .dry = 20,
            .sweet = 0,
    ...
    [BERRY_ID_KASIB] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("Alte Überlieferungen sagen, sie habe"),
            .description2 = COMPOUND_STRING("Kraft. Ein beliebter Glücksbringer."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 10,
            .sweet = 20,
    ...
    [BERRY_ID_HABAN] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("Weniger bitter, wenn man genug davon"),
            .description2 = COMPOUND_STRING("einkocht. Gibt gute Marmelade."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 0,
            .sweet = 10,
    ...
    [BERRY_ID_COLBUR] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("Winzige Haken an der Oberfläche haften"),
            .description2 = COMPOUND_STRING("an Pokémon, um ferne Orte zu erreichen."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_BABIRI] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("Sehr zäh mit kräftigem Geschmack."),
            .description2 = COMPOUND_STRING("Früher als Medizin verwendet."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 25,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_CHILAN] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("Daraus kann man eine Pfeife machen,"),
            .description2 = COMPOUND_STRING("die ein unbeschreibliches Geräusch macht."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 25,
            .sweet = 10,
    ...
    [BERRY_ID_LIECHI] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("Eine rätselhafte Beere. Gerüchten zufolge"),
            .description2 = COMPOUND_STRING("enthält sie die Kraft des Meeres."),
    ...
    [BERRY_ID_GANLON] =
    {
        .info = {
            ...
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("Eine rätselhafte Beere. Gerüchten zufolge"),
            .description2 = COMPOUND_STRING("enthält sie die Kraft des Landes."),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 0,
            .dry = 40,
            .sweet = 0,
    ...
    [BERRY_ID_SALAC] =
    {
        .info = {
            ...
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("Eine rätselhafte Beere. Gerüchten zufolge"),
            .description2 = COMPOUND_STRING("enthält sie die Kraft des Himmels."),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 0,
            .dry = 0,
            .sweet = 40,
    ...
    [BERRY_ID_PETAYA] =
    {
        .info = {
            ...
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("Eine rätselhafte Beere. Gerüchten zufolge"),
            .description2 = COMPOUND_STRING("enthält sie die Kraft aller Lebewesen."),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 40,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_APICOT] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 10, 13),
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("Eine sehr mysteriöse Beere. Man weiß nicht"),
            .description2 = COMPOUND_STRING("was passieren kann oder wie sie nutzbar ist."),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 0,
            .dry = 40,
            .sweet = 0,
    ...
    [BERRY_ID_LANSAT] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("Soll eine legendäre Beere sein."),
            .description2 = COMPOUND_STRING("Sie zu halten soll Freude bringen."),
    ...
    [BERRY_ID_STARF] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 5, 7),
            .minYield = YIELD_RATE(1, 1, 1, 1),
            .description1 = COMPOUND_STRING("So stark, dass sie zurückgelassen"),
            .description2 = COMPOUND_STRING("wurde. Gilt als Fata Morgana."),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 120, 48, 72),
            .spicy = 10,
            .dry = 10,
            .sweet = 10,
    ...
    [BERRY_ID_ENIGMA] =
    {
        .info = {
            ...
            .minYield = YIELD_RATE(1, 1, 1, 1),
            .description1 = COMPOUND_STRING("Eine völlig rätselhafte Beere."),
            .description2 = COMPOUND_STRING("Scheint die Kraft der Sterne zu haben."),
    ...
    [BERRY_ID_MICLE] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 5, 13),
            .minYield = YIELD_RATE(1, 1, 1, 1),
            .description1 = COMPOUND_STRING("Sie lässt andere Speisen"),
            .description2 = COMPOUND_STRING("süß schmecken."),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
            .spicy = 0,
            .dry = 40,
            .sweet = 10,
    ...
    [BERRY_ID_CUSTAP] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 5, 13),
            .minYield = YIELD_RATE(1, 1, 1, 1),
            .description1 = COMPOUND_STRING("Das Fruchtfleisch unter der Schale"),
            .description2 = COMPOUND_STRING("der Kapselbeere ist süß und cremig weich."),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
            .spicy = 0,
            .dry = 0,
            .sweet = 40,
    ...
    [BERRY_ID_JABOCA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 5, 13),
            .minYield = YIELD_RATE(1, 1, 1, 1),
            .description1 = COMPOUND_STRING("Die Körnchen dieser Beere knallen"),
            .description2 = COMPOUND_STRING("rhythmisch, wenn man sie schüttelt."),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_ROWAP] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 5, 13),
            .minYield = YIELD_RATE(1, 1, 1, 1),
            .description1 = COMPOUND_STRING("Früher machte man aus dieser"),
            .description2 = COMPOUND_STRING("Beere Spielzeug."),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
            .spicy = 10,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_ROSELI] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("In der Natur wachsen sie in weiten Ringen"),
            .description2 = COMPOUND_STRING("aus noch ungeklärten Gründen."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 0,
            .sweet = 25,
    ...
    [BERRY_ID_KEE] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 10, 13),
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("Eine zuerst unglaublich scharfe"),
            .description2 = COMPOUND_STRING("Beere, dann extrem bitter."),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 30,
            .dry = 30,
            .sweet = 10,
    ...
    [BERRY_ID_MARANGA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 10, 13),
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("Außen sehr bitter,"),
            .description2 = COMPOUND_STRING("innen süß."),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 10,
            .dry = 10,
            .sweet = 30,
