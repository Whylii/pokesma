const struct EasyChatWordInfo gEasyChatGroup_Endings[] = {
    ...
    [EC_INDEX(EC_WORD_A)] =
    {
        .text = COMPOUND_STRING("Ein"),
        .alphabeticalOrder = EC_INDEX(EC_WORD_IT),
        .enabled = TRUE,
    },
    [EC_INDEX(EC_WORD_AN)] =
    {
        .text = COMPOUND_STRING("Eine"),
