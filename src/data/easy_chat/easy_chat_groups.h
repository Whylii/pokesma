...
const struct EasyChatGroup gEasyChatGroups[EC_NUM_GROUPS] = {
    ...
    [EC_GROUP_LIFESTYLE] =
    {
        .name = COMPOUND_STRING("Lebensstil"),
    ...
    [EC_GROUP_ADJECTIVES] =
    {
        .name = COMPOUND_STRING("Adjektive"),
    ...
    [EC_GROUP_MOVE_1] =
    {
        .name = COMPOUND_STRING("Attacke 1"),
    ...
    [EC_GROUP_MOVE_2] =
    {
        .name = COMPOUND_STRING("Attacke 2"),
    ...
    {
        .name = COMPOUND_STRING("Trendsprüche"),
