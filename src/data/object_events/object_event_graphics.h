...
const u32 gObjectEventPic_GoldBall[] = INCGFX_U32("graphics/object_events/pics/misc/ball_poke_gold.png", ".4bpp", "-mwidth 2 -mheight 2");
...
const u32 gObjectEventPic_OldManLyingDown[] = INCGFX_U32("graphics/object_events/pics/people/old_man_lying_down.png", ".4bpp", "-mwidth 4 -mheight 4");
