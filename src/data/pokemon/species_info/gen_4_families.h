...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    "Der Panzer auf seinem Rücken\n"
    "besteht aus Lehm und wird härter,\n"
    "wenn das Pokémon Wasser trinkt.\n"
    "Es lebt am Ufer von Seen."),
        .pokemonScale = 491,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GROTLE] =
    {
        ...
        .weight = 970,
        .description = COMPOUND_STRING(
    "Es lebt in der Nähe von Gewässern im\n"
    "Wald. Tagsüber verlässt es diesen, um\n"
    "die Bäume auf seinem Panzer im\n"
    "Sonnenlicht zu baden."),
        .pokemonScale = 320,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TORTERRA] =
    {
        ...
        .weight = 3100,
        .description = COMPOUND_STRING(
    "Kleine Pokémon versammeln sich\n"
    "manchmal auf seinem reglosen Rücken\n"
    "und beginnen dort mit dem Nestbau."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
    ...
    [SPECIES_CHIMCHAR] =
    {
        ...
        .weight = 62,
        .description = COMPOUND_STRING(
    "Es lebt auf zerklüfteten Bergen und\n"
    "klettert mit Leichtigkeit steile Felswände\n"
    "hinauf. Bevor es schlafen geht, löscht\n"
    "es seine Flamme."),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
    ...
    "verstärkt es das Feuer an seinem\n"
    ...
    [SPECIES_INFERNAPE] =
    {
        ...
        .weight = 550,
        .description = COMPOUND_STRING(
    "Sein Temperament ist ebenso feurig\n"
    "wie die Flamme auf seinem Kopf.\n"
    "Niemand kann ihm in Sachen Schnelligkeit\n"
    "das Wasser reichen."),
        .pokemonScale = 282,
        .pokemonOffset = 3,
        .trainerScale = 256,
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        .weight = 52,
        .description = COMPOUND_STRING(
    "Sein stark ausgeprägter Stolz hält es\n"
    "davon ab, von Menschen Futter anzunehmen.\n"
    "Die dicke Daunenschicht schützt\n"
    "es vor Kälte."),
        .pokemonScale = 491,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_PRINPLUP] =
    {
        ...
        .weight = 230,
        .description = COMPOUND_STRING(
    "Dieses Pokémon kann durch Schläge\n"
    "seiner kräftigen Flügel selbst dicke\n"
    "Bäume umknicken. Es sucht im\n"
    "Eismeer nach Beute."),
        .pokemonScale = 366,
        .pokemonOffset = 10,
        .trainerScale = 257,
    ...
    [SPECIES_EMPOLEON] =
    {
        ...
        .weight = 845,
        .description = COMPOUND_STRING(
    "Es schwimmt so schnell wie ein\n"
    "Rennboot. Seine Flügel haben scharfe\n"
    "Kanten, die sogar Treibeis\n"
    ...
    [SPECIES_STARLY] =
    {
        ...
        .weight = 20,
        .description = COMPOUND_STRING(
    "Normalerweise ist es immer im\n"
    "Schwarm unterwegs, während es im\n"
    "Alleingang kaum auffällt. Sein\n"
    "Ruf ist äußerst durchdringend."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_STARAVIA] =
    {
        ...
        .weight = 155,
        .description = COMPOUND_STRING(
    "Es lebt in Wäldern und auf Wiesen.\n"
    "Treffen Schwärme von ihnen aufeinander,\n"
    "streiten sie sich sogleich um das Revier."),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_STARAPTOR] =
    {
        ...
        .weight = 249,
        .description = COMPOUND_STRING(
    "Die Muskeln in seinen Flügeln und Beinen\n"
    "sind so stark, dass es im Flug mühelos\n"
    "kleinere Pokémon tragen kann, indem es\n"
    "sie mit den Klauen festhält."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    "um die kräftigen Vorderzähne\n"
    "abzuschleifen. Sein Nest baut es\n"
    "in Wassernähe."),
        .pokemonScale = 432,
        .pokemonOffset = 16,
        .trainerScale = 256,
    ...
    [SPECIES_BIBAREL] =
    {
        ...
        .weight = 315,
        .description = COMPOUND_STRING(
    "Seine Bewegungen an Land mögen\n"
    "unbeholfen sein, doch im Wasser\n"
    "schwimmt es genauso schnell wie\n"
    "ein Barschwa."),
        .pokemonScale = 305,
        .pokemonOffset = 8,
        .trainerScale = 257,
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .weight = 22,
        .description = COMPOUND_STRING(
    "Die Töne, die es durch Aneinander-\n"
    "schlagen der Antennen erzeugt,\n"
    "dienen der Kommunikation. Der\n"
    "Klang ist typisch für Herbstnächte."),
        .pokemonScale = 530,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KRICKETUNE] =
    {
        ...
        .weight = 255,
        .description = COMPOUND_STRING(
    "Dieses Pokémon bringt seine Gefühle\n"
    "durch Melodien zum Ausdruck,\n"
    "deren Struktur auch von\n"
    "Wissenschaftlern untersucht wird."),
        .pokemonScale = 305,
        .pokemonOffset = 8,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_SHINX] =
    {
        ...
        .weight = 95,
        .description = COMPOUND_STRING(
    "Über die Muskulatur seiner Vorder-\n"
    "beine kann es Elektrizität\n"
    "erzeugen. Bei Gefahr leuchtet\n"
    ...
    [SPECIES_LUXIO] =
    {
        ...
        .weight = 305,
        .description = COMPOUND_STRING(
    "Es berührt Artgenossen mit seinen\n"
    "Vorderbeinen und teilt diesen\n"
    "seine Gefühle über rhythmische\n"
    "Stromstöße aus seinen Krallen mit."),
        .pokemonScale = 338,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LUXRAY] =
    {
        ...
        .weight = 420,
        .description = COMPOUND_STRING(
    "Leuchten seine Augen golden auf,\n"
    "kann es selbst Beute ausmachen,\n"
    "die sich hinter dicken Wänden\n"
    "versteckt."),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
    ...
    "lebte es im urzeitlichen Dschungel.\n"
    "Sein Schädel ist hart wie Eisen."),
        .pokemonScale = 338,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_RAMPARDOS] =
    {
        ...
        .weight = 1025,
        .description = COMPOUND_STRING(
    "Sein Schädel ist hart wie Eisen. Auf\n"
    "seiner wilden Jagd nach Beute reißt\n"
    "es ganze Dschungelbäume nieder."),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_SHIELDON] =
    {
        ...
        .description = COMPOUND_STRING(
    "Vor ungefähr 100 Millionen Jahren\n"
    "lebte es im Dschungel. Seine\n"
    "Gesichtshaut ist äußerst hart."),
        .pokemonScale = 432,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BASTIODON] =
    {
        ...
        .weight = 1495,
        .description = COMPOUND_STRING(
    "Dieses friedliche Pokémon, das sich\n"
    "von Gras und Beeren ernährt, schmettert\n"
    "jeden Frontalangriff ab."),
        .pokemonScale = 272,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BURMY_PLANT] =
    {
        ...
        .weight = 34,
        .description = COMPOUND_STRING(
    "Um sich vor eisigen Windstößen zu\n"
    "schützen, hüllt es sich in einen\n"
    "Umhang aus Laub und Zweigen."),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BURMY_SANDY] =
    {
        ...
        .weight = 34,
        .description = COMPOUND_STRING(
    "Es speit Fäden aus, die es mit Sand\n"
    "und Schlamm zu einem Umhang verarbeitet.\n"
    "Dieser ist jedoch nicht sehr wetterfest,\n"
    "weshalb es Schutz in Höhlen sucht"),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BURMY_TRASH] =
    {
        ...
        .weight = 34,
        .description = COMPOUND_STRING(
    "Findet es kein brauchbares Material,\n"
    "so fertigt es sich einen Umhang aus Unrat\n"
    "an, der sich dem Anschein nach als\n"
    "erstaunlich bequem erweist."),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WORMADAM_SANDY] =
    {
        ...
        .weight = 65,
        .description = COMPOUND_STRING(
    "Seine sandige Haut ist so hart\n"
    "dass etwaige Schnabelangriffe\n"
    "von Staralili mühelos an\n"
    "ihr abprallen."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_COMBEE] =
    {
        ...
        .weight = 55,
        .description = COMPOUND_STRING(
    "Ein Pokémon, geformt aus 3 einzelnen\n"
    "Pokémon. Fleißig bringt es Blütenhonig\n"
    "zu Honweisel."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
    ...
    "Larven. Sie füttert ihre Larven\n"
    "mit dem Honig, den Wadribie\n"
    "sammelt."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
    ...
    [SPECIES_PACHIRISU] =
    {
        ...
        .categoryName = _("E-Hörnchen"),
        .height = 4,
        .weight = 39,
        .description = COMPOUND_STRING(
    "Es bildet Fellknäuel, die vor\n"
    "statischer Energie nur so knistern.\n"
    "Diese versteckt es zusammen mit\n"
    "Beeren in Baumlöchern."),
        .pokemonScale = 491,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BUIZEL] =
    {
        ...
        .weight = 295,
        .description = COMPOUND_STRING(
    "Die Schwimmblase um seinen Hals dient\n"
    "ihm als Schwimmreifen, wenn es Luft\n"
    "darin speichert. So gerät sein Kopf\n"
    ...
    [SPECIES_FLOATZEL] =
    {
        ...
        .weight = 335,
        .description = COMPOUND_STRING(
    "Seine gut ausgeprägte Schwimmblase\n"
    "lässt es auf dem Wasser treiben, wo es\n"
    "Ertrinkenden zu Hilfe kommt."),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHERUBI] =
    {
        ...
        .weight = 33,
        .description = COMPOUND_STRING(
    "Das kleine Bällchen enthält alle\n"
    "Nährstoffe, die dieses Pokémon zur\n"
    "Entwicklung benötigt, und soll sehr süß\n"
    ...
    [SPECIES_CHERRIM_OVERCAST] =
    {
        ...
        .weight = 93,
        .description = COMPOUND_STRING(
    "Bei starkem Sonnenlicht blüht es auf\n"
    "und holt in Windeseile alles nach, was\n"
    "ihm als Knospe verwehrt blieb."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHERRIM_SUNSHINE] =
    {
        ...
        .weight = 93,
        .description = COMPOUND_STRING(
    "Bei Sonnenschein ist es äußerst rege,\n"
    "doch sobald Wolken aufziehen, schließt\n"
    "es umgehend seine Blütenblätter und\n"
    ...
    "unterscheiden sich je nach Habitat. In\n"
    "Sinnoh wurden zwei Varianten\n"
    "nachgewiesen."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
    ...
    [SPECIES_SHELLOS_EAST] =
    {
        ...
        .weight = 63,
        .description = COMPOUND_STRING(
    "Die unterschiedlichen Farben dieses\n"
    "Pokémon hängen von seinem Futter ab.\n"
    "Dies hat allerdings keinen Einfluss\n"
    ...
    [SPECIES_GASTRODON_WEST] =
    {
        ...
        .weight = 299,
        .description = COMPOUND_STRING(
    "Sein biegsamer Körper enthält keinen\n"
    "einzigen Knochen. Wird ein Körperteil\n"
    "abgetrennt, wächst es sofort nach."),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GASTRODON_EAST] =
    {
        ...
        .weight = 299,
        .description = COMPOUND_STRING(
    "Experimente sollen aufzeigen, was\n"
    "geschieht, wenn ein Gastrodon in einer\n"
    "anderen Gegend als dem Meer seiner\n"
    "Geburt aufgezogen wird."),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .weight = 12,
        .description = COMPOUND_STRING(
    "Driftlon entstand aus den Seelen von\n"
    "Menschen und Pokémon. Es mag feuchte\n"
    "Jahreszeiten."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
    ...
    [SPECIES_DRIFBLIM] =
    {
        ...
        .weight = 150,
        .description = COMPOUND_STRING(
    "Tagsüber treibt es schläfrig vor sich\n"
    "hin. Nachts fliegt es in Schwärmen\n"
    "umher, doch niemand weiß, wohin."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        .weight = 55,
        .description = COMPOUND_STRING(
    "Entrollt es seine eingerollten Ohren mit\n"
    "voller Wucht, teilt es so Schläge aus,\n"
    "durch die selbst erwachsene Gegner vor\n"
    "Schmerz aufspringen."),
        .pokemonScale = 491,
        .pokemonOffset = 16,
        .trainerScale = 256,
    ...
    [SPECIES_LOPUNNY] =
    {
        ...
        .weight = 333,
        .description = COMPOUND_STRING(
    "Wittert dieses äußerst vorsichtige\n"
    "Pokémon Gefahr, umwickelt es seinen\n"
    "Körper zum Schutz mit der weichen\n"
    "Wolle an seinen Ohren."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GLAMEOW] =
    {
        ...
        .weight = 39,
        .description = COMPOUND_STRING(
    "Bei Missfallen zeigt es zwar seine\n"
    "Krallen, doch manchmal schmiegt es sich\n"
    "auch schnurrend an. Dieses Verhalten\n"
    "ist bei einigen sehr beliebt."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PURUGLY] =
    {
        ...
        .weight = 438,
        .description = COMPOUND_STRING(
    "Dieses unverschämte Pokémon dringt\n"
    "einfach in die Behausung anderer\n"
    "Pokémon ein, um sich dort einzunisten."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_STUNKY] =
    {
        ...
        .weight = 192,
        .description = COMPOUND_STRING(
    "Zum Schutz versprüht es eine enorm\n"
    "stinkende Flüssigkeit aus seinem\n"
    "Hinterleib, deren Geruch 24 Stunden\n"
    "lang anhält."),
        .pokemonScale = 491,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_SKUNTANK] =
    {
        ...
        .weight = 380,
        .description = COMPOUND_STRING(
    "Wenn es angreift, sprüht es mit\n"
    "einer Reichweite von mehr als\n"
    "50 m eine übel riechende Flüssigkeit\n"
    "aus seiner Schweifspitze."),
        .pokemonScale = 305,
        .pokemonOffset = 9,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_BRONZOR] =
    {
        ...
        .weight = 605,
        .description = COMPOUND_STRING(
    "In alten Gräbern wurden Gegenstände\n"
    "gefunden, die Bronzel zum Verwechseln\n"
    "ähnlich sehen, doch es ist unklar,\n"
    ...
    [SPECIES_BRONZONG] =
    {
        ...
        .weight = 1870,
        .description = COMPOUND_STRING(
    "Es wurde nach zweitausendjährigem\n"
    "Schlaf bei Grabungen auf einer\n"
    "Baustelle entdeckt und sorgte so\n"
    ...
    "nachahmen. Sammeln sich mehrere\n"
    "an einem Ort, lernen sie alle\n"
    "dieselben Wörter."),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .weight = 1080,
        .description = COMPOUND_STRING(
    "Ein Pokémon, das aus 108 Seelen\n"
    "besteht. Es ist an einen Spalt in\n"
    "einem Spiritkern gebunden."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_GIBLE] =
    {
        ...
        .weight = 205,
        .description = COMPOUND_STRING(
    "Dieses Pokémon nistet in kleinen\n"
    "Löchern in Höhlenwänden. Es springt\n"
    "Beute an, die sich zu nah heranwagt,\n"
    "und schnappt zu."),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
    ...
    [SPECIES_GABITE] =
    {
        ...
        .weight = 560,
        .description = COMPOUND_STRING(
    "Schon seit uralten Zeiten glaubt man,\n"
    "dass sich mit Medizin aus den Schuppen\n"
    "dieses Pokémon selbst unheilbare\n"
    "Krankheiten kurieren lassen."),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    "und seine Flügel ausbreitet, ähnelt\n"
    "es einem Jet. Es fliegt mit\n"
    ...
    [SPECIES_RIOLU] =
    {
        ...
        .weight = 202,
        .description = COMPOUND_STRING(
    "Riolu strahlt eine Aura aus, die sich\n"
    "verstärkt, wenn es Angst oder Trauer\n"
    "verspürt. Dadurch werden seine\n"
    "Artgenossen bei Gefahr alarmiert."),
        .pokemonScale = 365,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        .weight = 540,
        .description = COMPOUND_STRING(
    "Es ist imstande, die Aura aller\n"
    "Dinge zu spüren, und versteht\n"
    "zudem die menschliche Sprache."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HIPPOWDON] =
    {
        ...
        .categoryName = _("Schwergew."),
        .height = 20,
        .weight = 3000,
        .description = COMPOUND_STRING(
    "Es wirbelt den Sand, den es in seinem\n"
    "Körper sammelt, durch die Öffnungen\n"
    "hinaus und erzeugt so eine große\n"
    "Windhose, mit der es angreift."),
        .pokemonScale = 261,
        .pokemonOffset = 2,
        .trainerScale = 334,
        .trainerOffset = 4,
    ...
    [SPECIES_SKORUPI] =
    {
        ...
        .weight = 120,
        .description = COMPOUND_STRING(
    "Es ergreift seine Beute mit den Klauen\n"
    "an seinem Schwanz, vergiftet sie und\n"
    "lässt sie erst dann wieder los, wenn\n"
    "das Gift Wirkung gezeigt hat."),
        .pokemonScale = 366,
        .pokemonOffset = 12,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_DRAPION] =
    {
        ...
        .weight = 615,
        .description = COMPOUND_STRING(
    "Die zerstörerischen Klauen an seinen\n"
    "Armen können nicht nur Autos\n"
    "demolieren, sondern setzen außerdem\n"
    "über ihre Enden Gift frei."),
        .pokemonScale = 272,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .weight = 230,
        .description = COMPOUND_STRING(
    "In seinen Backen befinden sich\n"
    "Giftbeutel. Es versucht, Beute zu\n"
    "überrumpeln, um dann mit seinen\n"
    "hochgiftigen Fingern zuzustechen."),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TOXICROAK] =
    {
        ...
        .weight = 444,
        .description = COMPOUND_STRING(
    "Die Klauen an seinen\n"
    "Fingerknöcheln geben ein so\n"
    "starkes Gift ab, dass selbst ein\n"
    "kleiner Kratzer tödlich ist."),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CARNIVINE] =
    {
        ...
        .weight = 270,
        .description = COMPOUND_STRING(
    "Mit süßlich riechendem Speichel lockt\n"
    "es Beute an und schnappt dann mit\n"
    "seinen gewaltigen Kiefern zu.\n"
    "Es braucht einen Tag, um sie zu essen."),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_FINNEON] =
    {
        ...
        .weight = 70,
        .description = COMPOUND_STRING(
    "Wenn es lange dem Sonnenlicht\n"
    "ausgesetzt war, leuchten die Muster\n"
    "auf seinen Schwanzflossen bei\n"
    "Dunkelheit in intensiven Farben."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LUMINEON] =
    {
        ...
        .weight = 240,
        .description = COMPOUND_STRING(
    "Dieses Pokémon lebt auf dem Grund\n"
    "der Tiefsee und lockt Beute an,\n"
    "indem es die Muster auf seinen\n"
    "vier Rückenflossen aufleuchten lässt."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .weight = 505,
        .description = COMPOUND_STRING(
    "Da es auf schneebedeckten Bergen\n"
    "zu Hause ist und dort kaum Kontakt\n"
    "zu Menschen hat, nähert es sich\n"
    "diesen mit großer Neugier."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_ABOMASNOW] =
    {
        ...
        .weight = 1355,
        .description = COMPOUND_STRING(
    "Dieses Pokémon lebt auf Bergen,\n"
    "wo ewiger Schnee liegt, und löst\n"
    "dort Blizzards aus. Mitunter wird\n"
    "es für einen Schneemenschen\n"
    "gehalten."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
...
#define ROTOM_FAMILY_TYPES { TYPE_ELECTRIC, TYPE_GHOST }
    ...
    [SPECIES_ROTOM] =
    {
        ...
        .weight = 3,
        .description = COMPOUND_STRING(
    "Sein Körper besteht aus Plasma.\n"
    "Es ist dafür bekannt, in\n"
    "elektrische Geräte einzudringen\n"
    ...
    "Motor betrieben wird. Im Umgang mit\n"
    "Feuer ist es sehr geschickt."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ROTOM_WASH] =
    {
        ...
        .weight = 3,
        .description = COMPOUND_STRING(
    "Dieses Rotom ist in eine Waschmaschine\n"
    "eingedrungen. Es setzt alles um sich\n"
    "herum unter Wasser und nickt\n"
    "dann selbstgefällig."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
    ...
    [SPECIES_ROTOM_FROST] =
    {
        ...
        .weight = 3,
        .description = COMPOUND_STRING(
    "Dieses Rotom ist in einen Kühlschrank\n"
    "eingedrungen. Mit eiskalter Luft friert\n"
    "es seine Umgebung ein und springt\n"
    "dann fröhlich umher."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
    ...
    [SPECIES_ROTOM_FAN] =
    {
        ...
        .weight = 3,
        .description = COMPOUND_STRING(
    "Diese Form von Rotom liebt es,\n"
    "mit Wind für Chaos zu sorgen.\n"
    "Mit Windstößen bringt es wichtige\n"
    "Dokumente durcheinander."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ROTOM_MOW] =
    {
        ...
        .description = COMPOUND_STRING(
    "Diese Form von Rotom liebt es,\n"
    "mit Pflanzen für Chaos zu sorgen.\n"
    "Es mäht mühsam gepflegte Blumen\n"
    "ohne Gnade nieder."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
    ...
    [SPECIES_UXIE] =
    {
        ...
        .weight = 3,
        .description = COMPOUND_STRING(
    "Es wird auch das wissende Wesen\n"
    "genannt und soll die Erinnerungen\n"
    "derer löschen können, die ihm in\n"
    "die Augen sehen."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
    ...
    [SPECIES_MESPRIT] =
    {
        ...
        .weight = 3,
        .description = COMPOUND_STRING(
    "Es wird auch das fühlende Wesen genannt.\n"
    "Einst lehrte es die Menschen den\n"
    "durch Trauer verursachten Schmerz\n"
    "und den Wert von Freude."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AZELF] =
    {
        ...
        .weight = 3,
        .description = COMPOUND_STRING(
    "Es wird auch das starke Wesen\n"
    "genannt. Auf dem Grund eines Sees\n"
    "schlafend hält es die Welt im\n"
    "Gleichgewicht."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
    ...
    "Sinnoh wird es als eine\n"
    "Gottheit dargestellt."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 721,
        .trainerOffset = 19,
    ...
    "gewaltige Stärke nährt den Verdacht, dass\n"
    "es sich um sein wahres Antlitz handelt."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 721,
        .trainerOffset = 19,
    ...
    [SPECIES_PALKIA] =
    {
        ...
        .weight = 3360,
        .description = COMPOUND_STRING(
    "Von diesem in der Mythologie erwähnten\n"
    "Pokémon heißt es, dass es in einem\n"
    "Spalt zwischen parallelen Dimensionen\n"
    "lebe."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 650,
    ...
    [SPECIES_PALKIA_ORIGIN] =
    {
        ...
        .weight = 6600,
        .description = COMPOUND_STRING(
    "Dem Schöpfer aller Dinge gleich gleitet\n"
    "es über das Himmelszelt. Womöglich gebärdet\n"
    ...
    "Dank seiner kreuzförmigen Klauen\n"
    "kann es sogar an der Decke\n"
    "oder an Wänden laufen."),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 290,
        .trainerOffset = 1,
    ...
    [SPECIES_REGIGIGAS] =
    {
        ...
        .weight = 4200,
        .description = COMPOUND_STRING(
    "Einer Legende nach verrückte\n"
    "dieses Pokémon einst Kontinente,\n"
    "indem es sie mithilfe eines\n"
    "Seils zog."),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 610,
    ...
    [SPECIES_GIRATINA_ALTERED] =
    {
        ...
        .weight = 7500,
        .description = COMPOUND_STRING(
    "Ein Pokémon, das in einer Welt\n"
    "auf der Kehrseite der unsrigen leben\n"
    "soll. Es tritt auf altertümlichen\n"
    "Friedhöfen in Erscheinung."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 614,
        .trainerOffset = 13,
    ...
    "Beine. Dieses Pokémon muss wohl in einer\n"
    "Welt leben, in der Himmel und Erde eins\n"
    "sind, jedoch ist dies nicht nachzuweisen."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 614,
        .trainerOffset = 13,
    ...
    [SPECIES_CRESSELIA] =
    {
        ...
        .weight = 856,
        .description = COMPOUND_STRING(
    "Im Flug geben seine schleierartigen\n"
    "Flügel schimmernde Partikel ab.\n"
    "Man sagt, es verkörpere die\n"
    "Mondsichel."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
    ...
    [SPECIES_PHIONE] =
    {
        ...
        .weight = 31,
        .description = COMPOUND_STRING(
    "Es ist in warmen Meeren zu Hause\n"
    "und bläst den Schwimmbeutel am Kopf\n"
    "auf, um sich bei der Nahrungssuche auf\n"
    ...
    [SPECIES_MANAPHY] =
    {
        ...
        .weight = 14,
        .description = COMPOUND_STRING(
    "Schwimmend bewältigt es große\n"
    "Distanzen, um an den kalten\n"
    "Meeresgrund zurückzukehren, auf\n"
    ...
    [SPECIES_DARKRAI] =
    {
        ...
        .weight = 505,
        .description = COMPOUND_STRING(
    "Es kann andere in tiefen Schlaf\n"
    "versetzen und träumen lassen.\n"
    "In Neumondnächten wird es aktiv."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    "sich ein, um selbst wie eine Blume\n"
    "auszusehen und so unerkannt zu\n"
    "bleiben."),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
    ...
    [SPECIES_SHAYMIN_SKY] =
    {
        ...
        .weight = 52,
        .description = COMPOUND_STRING(
    "Riecht es an einer gewissen seltenen Blume,\n"
    "wird sein kleiner Körper von Licht umhüllt\n"
    "und vollzieht einen Formwandel. Auf mich\n"
    "hatte das Riechen dieser Blume keinen Effekt."),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
