...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_HERDIER] =
    {
        ...
        .speciesName = _("Terribiss"),
        .cryId = CRY_HERDIER,
        .natDexNum = NATIONAL_DEX_HERDIER,
        .categoryName = _("Gefährte"),
        .height = 9,
        .weight = 147,
        .description = COMPOUND_STRING(
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_KROOKODILE] =
    {
        ...
        .categoryName = _("Einschüchterung"),
        .height = 15,
        .weight = 963,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_REUNICLUS] =
    {
        ...
        .abilities = { ABILITY_OVERCOAT, ABILITY_MAGIC_GUARD, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Zytomator"),
        .cryId = CRY_REUNICLUS,
        .natDexNum = NATIONAL_DEX_REUNICLUS,
        .categoryName = _("Vervielfältigung"),
        .height = 10,
        .weight = 201,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SWANNA] =
    {
        ...
        .abilities = { ABILITY_KEEN_EYE, ABILITY_BIG_PECKS, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Swanblo"),
        .cryId = CRY_SWANNA,
        .natDexNum = NATIONAL_DEX_SWANNA,
        .categoryName = _("Weißvogel"),
        .height = 13,
        .weight = 242,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_FERROSEED] =
    {
        ...
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Kiesfresser"),
        .cryId = CRY_FERROSEED,
        .natDexNum = NATIONAL_DEX_FERROSEED,
        .categoryName = _("Dornsamen"),
        .height = 6,
        .weight = 188,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_TYNAMO] =
    {
        ...
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Zapplading"),
        .cryId = CRY_TYNAMO,
        .natDexNum = NATIONAL_DEX_TYNAMO,
        .categoryName = _("Strom"),
        .height = 2,
        .weight = 3,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_PAWNIARD] =
    {
        ...
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Glognion"),
        .cryId = CRY_PAWNIARD,
        .natDexNum = NATIONAL_DEX_PAWNIARD,
        .categoryName = _("Klingenklinge"),
        .height = 5,
        .weight = 102,
        .description = COMPOUND_STRING(
