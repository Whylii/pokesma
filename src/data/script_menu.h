...
static const struct MenuAction MultichoiceList_ContestInfo[] =
{
    ...
    {COMPOUND_STRING("Wettbewerbsarten")},
    {COMPOUND_STRING("Ränge")},
    {gText_Cancel2},
};
...
const u8 gText_Registry[] = _("Registrierung");
...
{
    {COMPOUND_STRING("Verg")},
    {COMPOUND_STRING("Para")},
    {COMPOUND_STRING("Schl")},
    {COMPOUND_STRING("Verb")},
    {COMPOUND_STRING("Gefr")},
    {gText_Exit},
};
...
{
    {COMPOUND_STRING("Sie werden mehr kosten.")},
    {COMPOUND_STRING("Sie werden weniger kosten.")},
    {COMPOUND_STRING("Gleicher Preis")},
};
...
{
    {COMPOUND_STRING("Tafelwasser{CLEAR_TO 72}¥200")},
    {COMPOUND_STRING("Sprudel{CLEAR_TO 72}¥300")},
    {COMPOUND_STRING("Limonade{CLEAR_TO 72}¥350")},
    {gText_Exit},
};

static const struct MenuAction MultichoiceList_MachBikeInfo[] =
{
    {COMPOUND_STRING("Fahrweise")},
    {COMPOUND_STRING("Wenden")},
    {COMPOUND_STRING("Sandhänge")},
    {gText_Exit},
};
...
{
    {COMPOUND_STRING("Tiefseezahn")},
    {COMPOUND_STRING("Tiefseeschuppe")},
    {gText_Exit},
};
...
static const struct MenuAction MultichoiceList_UnusedAshVendor[] =
{
    ...
    {COMPOUND_STRING("Glasschreibtisch")},
    {gText_Cancel2},
};

static const struct MenuAction MultichoiceList_GameCornerDolls[] =
{
    {COMPOUND_STRING("Geckarbor-Puppe 1.000 Münzen")},
    {COMPOUND_STRING("Flemmli-Puppe 1.000 Münzen")},
    {COMPOUND_STRING("Hydropi-Puppe 1.000 Münzen")},
    {gText_Exit},
};
...
const u8 gText_TradeCenter[] = _("Tauschbörse");
...
static const struct MenuAction MultichoiceList_WirelessMinigame[] =
{
    ...
    {COMPOUND_STRING("Dodri-Beerenpflücken")},
    {gText_Exit},
};
...
{
    {COMPOUND_STRING("Normalrang")},
    {COMPOUND_STRING("Superrang")},
    {COMPOUND_STRING("Hyperrang")},
    {COMPOUND_STRING("Masterrang")},
    {gText_Exit},
};

static const struct MenuAction MultichoiceList_FrontierItemChoose[] =
{
    {COMPOUND_STRING("Kampfbeutel")},
...
static const struct MenuAction MultichoiceList_LinkContestInfo[] =
{
    ...
    {COMPOUND_STRING("Über E-Modus")},
    {COMPOUND_STRING("Über G-Modus")},
    {gText_Cancel2},
};
...
{
    {COMPOUND_STRING("  5KP")},
    {COMPOUND_STRING("10KP")},
    {COMPOUND_STRING("15KP")},
    {gText_Exit},
};
...
{
    {COMPOUND_STRING("Zwei Arten")},
    {COMPOUND_STRING("Lv. 50")},
    {COMPOUND_STRING("Offenes Level")},
...
static const struct MenuAction MultichoiceList_FrontierPassInfo[] =
{
    ...
    {COMPOUND_STRING("Kampfpunkte")},
    {gText_Exit},
};

const u8 gText_BattleRules[] = _("Kampfregeln");
const u8 gText_JudgeMind[] = _("Ringrichter: Verstand");
const u8 gText_JudgeSkill[] = _("Ringrichter: Geschick");
const u8 gText_JudgeBody[] = _("Ringrichter: Körper");
...
{
    {COMPOUND_STRING("Turm-Info")},
    {COMPOUND_STRING("Kampf-{PKMN}")},
    {COMPOUND_STRING("Kampfsalon")},
...
const u8 gText_SwapNotes[] = _("Tausch: Noten");
...
{
    {COMPOUND_STRING("PokéNav und Beutel")},
    {COMPOUND_STRING("Getragenge Items")},
...
{
    {COMPOUND_STRING("Ich kämpfe jetzt!")},
    {COMPOUND_STRING("Ich gewann!")},
    {COMPOUND_STRING("Ich verlor!")},
    {COMPOUND_STRING("Ich sag es nicht.")},
};

static const struct MenuAction MultichoiceList_WheresRayquaza[] =
{
    {COMPOUND_STRING("Höhle des Ursprungs")},
    {COMPOUND_STRING("Pyroberg")},
    {COMPOUND_STRING("Himmelssäule")},
    {COMPOUND_STRING("Weiß nicht mehr")},
};
...
static const struct MenuAction sMultichoiceList_Eeveelutions[] = {
    ...
    {COMPOUND_STRING("Nicht mehr umschauen.")}
};
...
static const struct MenuAction sMultichoiceList_LinkedDirectUnion[] = {
    {COMPOUND_STRING("Verbundenes Spiel")},
    {COMPOUND_STRING("Ecke für Direktverbindung")},
    {COMPOUND_STRING("Union-Raum")},
    {gText_Exit}
};
...
static const struct MenuAction sMultichoiceList_Mushrooms[] = {
    {COMPOUND_STRING("2 Kleinpilze")},
    {COMPOUND_STRING("1 Großpilz")}
};
...
const u8 *const gStdStrings[] =
{
    ...
    [STDSTRING_BEAUTY2] = COMPOUND_STRING("Schönheit"),
    [STDSTRING_CUTE2] = COMPOUND_STRING("Niedlichkeit"),
    [STDSTRING_SMART2] = COMPOUND_STRING("Klugheit"),
    [STDSTRING_TOUGH2] = COMPOUND_STRING("Stärke"),
    [STDSTRING_ITEMS] = COMPOUND_STRING("Items"),
    [STDSTRING_KEYITEMS] = COMPOUND_STRING("Basis-Items"),
    [STDSTRING_POKEBALLS] = COMPOUND_STRING("Pokéballs"),
    [STDSTRING_TMHMS] = COMPOUND_STRING("TMs & VMs"),
    [STDSTRING_BERRIES] = COMPOUND_STRING("Beeren"),
    [STDSTRING_SINGLE] = COMPOUND_STRING("Einzel"),
    [STDSTRING_DOUBLE] = COMPOUND_STRING("Doppel"),
...
static const u8 *const sSeagallopDestStrings[] = {
    ...
    [SEAGALLOP_FOUR_ISLAND]    = COMPOUND_STRING("Eiland 4"),
    [SEAGALLOP_FIVE_ISLAND]    = COMPOUND_STRING("Eiland 5"),
    [SEAGALLOP_SIX_ISLAND]     = COMPOUND_STRING("Eiland 6"),
    [SEAGALLOP_SEVEN_ISLAND]   = COMPOUND_STRING("Eiland 7"),
};
