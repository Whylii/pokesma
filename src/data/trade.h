...
static const u8 sText_SpaceMove[] = _(" bewegen"); // unused
...
static const u8 sText_IsThisTradeOkay[] = _("Diesen Tausch annehmen?");
...
static const u8 sText_CommunicationStandby[] = _("{BACKGROUND WHITE}{TEXT_COLORS DARK_GRAY LIGHT_GRAY WHITE}Kommunikation…\nBitte warten.");
static const u8 sText_TheTradeHasBeenCanceled[] = _("{BACKGROUND WHITE}{TEXT_COLORS DARK_GRAY LIGHT_GRAY WHITE}Der Tausch wurde\nabgrebrochen.");
static const u8 sText_OnlyPkmnForBattle[] = _("Das ist dein letztes\nkampffähiges Pokémon.");
static const u8 sText_WaitingForYourFriend[] = _("{BACKGROUND WHITE}{TEXT_COLORS DARK_GRAY LIGHT_GRAY WHITE}Auf deinen Freund\nwarten…");
