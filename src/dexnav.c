...
static const u8 sText_DexNav_CaptureToSee[] = _("Zuerst fangen!");
static const u8 sText_DexNav_PressRToRegister[] = _("R zum Registrieren!");
static const u8 sText_DexNav_SearchForRegisteredSpecies[] = _("Suche {STR_VAR_1}");
static const u8 sText_DexNav_NotFoundHere[] = _("Dieses Pokémon kann hier nicht gefunden werden!");
static const u8 sText_ThreeQmarks[] = _("???");
static const u8 sText_SearchLevel[] = _("Suche {LV}. {STR_VAR_1}");
static const u8 sText_MonLevel[] = _("{LV}. {STR_VAR_1}");
static const u8 sText_EggMove[] = _("Attacke: {STR_VAR_1}");
static const u8 sText_HeldItem[] = _("{STR_VAR_1}");
static const u8 sText_StartExit[] = _("{START_BUTTON} Verlassen");
