...
static const u8 sText_PlayerScurriedToCenter[] = _("{PLAYER} rannte zu einem Pokémon-Center,\num seine verletzten Pokémon\nzu beschützen…\p");
static const u8 sText_PlayerScurriedBackHome[] = _("{PLAYER} rannte nach Hause,\num seine verletzten Pokémon\nzu beschützen…\p");
static const u8 sText_PlayerRegroupCenter[] = _("{PLAYER} rannte zu einem Pokémon-Center,\num sich eine bessere Strategie\nzurechtzulegen…\p");
static const u8 sText_PlayerRegroupHome[] = _("{PLAYER} rannte nach Hause,\num sich eine bessere Strategie\nzurechtzulegen…\p");
...
static void Task_RushInjuredPokemonToCenter(u8 taskId)
{
    ...
    case WHITEOUT_CUTSCENE_HEAL_SCRIPT:
        if (WaitForWeatherFadeIn() == TRUE)
        {
            ...
            {
                if (IS_FRLG)
                    StringCopy(gStringVar1, COMPOUND_STRING("Prof. Eich"));
                else
                    StringCopy(gStringVar1, COMPOUND_STRING("Prof. Birk"));
