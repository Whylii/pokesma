...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    [SCROLL_MULTI_GLASS_WORKSHOP_VENDOR] =
    {
        ...
        COMPOUND_STRING("Hübscher Stuhl"),
        COMPOUND_STRING("Hübscher Schreibtisch"),
        gText_Exit
    },
    [SCROLL_MULTI_POKEMON_FAN_CLUB_RATER] =
    {
        COMPOUND_STRING("0 P."),
        COMPOUND_STRING("10 P."),
        COMPOUND_STRING("20 P."),
        COMPOUND_STRING("30 P."),
        COMPOUND_STRING("40 P."),
        COMPOUND_STRING("50 P."),
        COMPOUND_STRING("60 P."),
        COMPOUND_STRING("70 P."),
        COMPOUND_STRING("80 P."),
        COMPOUND_STRING("90 P."),
        COMPOUND_STRING("100 P."),
        COMPOUND_STRING("?")
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_DECOR_VENDOR_1] =
    {
        COMPOUND_STRING("Kuss-Poster{CLEAR_TO 94}16BP"),
        COMPOUND_STRING("Kuss-Kissen{CLEAR_TO 94}32BP"),
        COMPOUND_STRING("Kussilla-Puppe{CLEAR_TO 94}32BP"),
        COMPOUND_STRING("Togepi-Puppe{CLEAR_TO 94}48BP"),
        COMPOUND_STRING("Mauzi-Puppe{CLEAR_TO 94}48BP"),
        COMPOUND_STRING("Piepi-Puppe{CLEAR_TO 94}48BP"),
        COMPOUND_STRING("Ditto-Puppe{CLEAR_TO 94}48BP"),
        COMPOUND_STRING("Feurigel-Puppe{CLEAR_TO 94}80BP"),
        COMPOUND_STRING("Endivie-Puppe{CLEAR_TO 94}80BP"),
        COMPOUND_STRING("Karnimani-Puppe{CLEAR_TO 94}80BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_DECOR_VENDOR_2] =
    {
        COMPOUND_STRING("Lapras-Puppe{CLEAR_TO 88}128BP"),
        COMPOUND_STRING("Relaxo-Puppe{CLEAR_TO 88}128BP"),
        COMPOUND_STRING("Bisaflor-Puppe{CLEAR_TO 88}256BP"),
        COMPOUND_STRING("Glurak-Puppe{CLEAR_TO 88}256BP"),
        COMPOUND_STRING("Turtok-Puppe{CLEAR_TO 88}256BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_VITAMIN_VENDOR] =
    {
        COMPOUND_STRING("Protein{CLEAR_TO 100}1BP"),
        COMPOUND_STRING("Kalzium{CLEAR_TO 100}1BP"),
        COMPOUND_STRING("Eisen{CLEAR_TO 100}1BP"),
        COMPOUND_STRING("Zink{CLEAR_TO 100}1BP"),
        COMPOUND_STRING("Carbon{CLEAR_TO 100}1BP"),
        COMPOUND_STRING("KP-Plus{CLEAR_TO 100}1BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_HOLD_ITEM_VENDOR] =
    {
        COMPOUND_STRING("Überreste{CLEAR_TO 94}48BP"),
        COMPOUND_STRING("Weißkraut{CLEAR_TO 94}48BP"),
        COMPOUND_STRING("Flinkklaue{CLEAR_TO 94}48BP"),
        COMPOUND_STRING("Mentalkraut{CLEAR_TO 94}48BP"),
        COMPOUND_STRING("Blendpuder{CLEAR_TO 94}64BP"),
        COMPOUND_STRING("Wahlband{CLEAR_TO 94}64BP"),
        COMPOUND_STRING("King-Stein{CLEAR_TO 94}64BP"),
        COMPOUND_STRING("Fokusband{CLEAR_TO 94}64BP"),
        COMPOUND_STRING("Scope-Linse{CLEAR_TO 94}64BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BERRY_POWDER_VENDOR] =
    {
        COMPOUND_STRING("Energiepuder{CLEAR_TO 114}{FONT_SMALL}50"),
        COMPOUND_STRING("Energiewurzel{CLEAR_TO 114}{FONT_SMALL}80"),
    ...
    {
        COMPOUND_STRING("Weichei{CLEAR_TO 78}16GP"),
        COMPOUND_STRING("Geowurf{CLEAR_TO 78}24GP"),
        COMPOUND_STRING("Traumfresser{CLEAR_TO 78}24GP"),
        COMPOUND_STRING("Megahieb{CLEAR_TO 78}24GP"),
        COMPOUND_STRING("Megakick{CLEAR_TO 78}48GP"),
        COMPOUND_STRING("Bodyslam{CLEAR_TO 78}48GP"),
        COMPOUND_STRING("Steinwurf{CLEAR_TO 78}48GP"),
        COMPOUND_STRING("Konter{CLEAR_TO 78}48GP"),
        COMPOUND_STRING("Donnerwelle{CLEAR_TO 78}48GP"),
        COMPOUND_STRING("Schwerttanz{CLEAR_TO 78}48GP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_MOVE_TUTOR_2] =
    {
        COMPOUND_STRING("Panzerschutz{CLEAR_TO 78}16GP"),
        COMPOUND_STRING("Schnarcher{CLEAR_TO 78}24GP"),
        COMPOUND_STRING("Lehmschelle{CLEAR_TO 78}24GP"),
        COMPOUND_STRING("Sternenhieb{CLEAR_TO 78}24GP"),
        COMPOUND_STRING("Eissturm{CLEAR_TO 78}24GP"),
        COMPOUND_STRING("Ausdauer{CLEAR_TO 78}48GP"),
        COMPOUND_STRING("Psycho-Plus{CLEAR_TO 78}48GP"),
        COMPOUND_STRING("Eishieb{CLEAR_TO 78}48GP"),
        COMPOUND_STRING("Donnerschlag{CLEAR_TO 78}48GP"),
        COMPOUND_STRING("Feuerschlag{CLEAR_TO 78}48GP"),
        gText_Exit
    },
