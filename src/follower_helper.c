...
static const u8 sCondMsg01[] = _("{STR_VAR_1} tanzte anmutig.");
static const u8* const sCelebiTexts[] = {sCondMsg00, sCondMsg01, NULL};
static const u8 sCondMsg02[] = _("{STR_VAR_1} stieß Feuer aus\nund brüllte!");
static const u8 sCondMsg03[] = _("{STR_VAR_1} produziert kräftig\nFeuer!");
static const u8 sCondMsg04[] = _("{STR_VAR_1} spuckte Feuer!");
static const u8 sCondMsg05[] = _("{STR_VAR_1} atmet kräftig\nFeuer!");
static const u8* const sFireTexts[] = {sCondMsg02, sCondMsg03, sCondMsg04, sCondMsg05, NULL};
static const u8 sCondMsg06[] = _("{STR_VAR_1} starrt direkt auf\ndie Pokémon Liga.");
static const u8 sCondMsg07[] = _("Dein Pokémon starrt gebannt\nauf die Bergspitze.");
static const u8 sCondMsg08[] = _("Schnüffel, schnüffel, das\nriecht gut!");
static const u8 sCondMsg09[] = _("Dein Pokémon mustert unruhig\ndie Regale.");
static const u8 sCondMsg10[] = _("{STR_VAR_1} starrt gebannt\nauf die Regale.");
static const u8* const sShopTexts[] = {sCondMsg09, sCondMsg10, NULL};
static const u8 sCondMsg11[] = _("{STR_VAR_1} konzentrierte sich\nmit scharfem Blick!");
static const u8 sCondMsg12[] = _("{STR_VAR_1} scheint sehr an den\nFahrrädern interessiert.");
static const u8 sCondMsg13[] = _("{STR_VAR_1} will die Maschinen\nberühren!");
static const u8 sCondMsg14[] = _("{STR_VAR_1} schwingt mit dem\nBoot!");
static const u8 sCondMsg15[] = _("{STR_VAR_1} tanzt zum Schaukeln\ndes Schiffs.");
static const u8 sCondMsg16[] = _("{STR_VAR_1} will noch nicht\nvon Bord gehen!");
static const u8* const sBoatTexts[] = {sCondMsg14, sCondMsg15, sCondMsg16, NULL};
static const u8 sCondMsg17[] = _("{STR_VAR_1} lauscht dem Klang\nder Maschinen.");
static const u8* const sMachineTexts[] = {sCondMsg13, sCondMsg17, NULL};
static const u8 sCondMsg18[] = _("Waah! Dein Pokémon spritzte\nplötzlich Wasser!");
static const u8 sCondMsg19[] = _("Dein Pokémon bläst Sand\nin die Luft!");
static const u8 sCondMsg20[] = _("{STR_VAR_1} spielt herum\nund zupft Grashalme aus.");
static const u8 sCondMsg21[] = _("Dein Pokémon sieht sich\nfröhlich deine Fußspuren an!");
static const u8 sCondMsg22[] = _("{STR_VAR_1} fühlt sich nervös\nund etwas beengt.");
static const u8 sCondMsg23[] = _("{STR_VAR_1} ist vorsichtig\nim engen Bereich!");
static const u8* const sElevatorTexts[] = {sCondMsg22, sCondMsg23, NULL};
static const u8 sCondMsg24[] = _("Ein kalter Wind wehte\nplötzlich vorbei!");
static const u8 sCondMsg25[] = _("Dein Pokémon rutschte fast\naus und fiel hin!");
static const u8 sCondMsg26[] = _("Dein Pokémon scheint\nüberrascht, Eis zu berühren.");
static const u8* const sColdTexts[] = {sCondMsg24, sCondMsg25, sCondMsg26, NULL};
static const u8 sCondMsg27[] = _("Dein Pokémon hat ein\nBlütenblatt im Gesicht!");
static const u8 sCondMsg28[] = _("{STR_VAR_1} knurrt leise.");
static const u8 sCondMsg29[] = _("{STR_VAR_1} zittert vor Angst.");
static const u8 sCondMsg30[] = _("{STR_VAR_1} wirkt irgendwie\ntraurig…");
static const u8* const sFearTexts[] = {sCondMsg29, sCondMsg30, NULL};
static const u8 sCondMsg31[] = _("{STR_VAR_1} sucht Schutz im\nGras vor dem Regen.");
static const u8 sCondMsg32[] = _("{STR_VAR_1} friert sehr.");
static const u8 sCondMsg33[] = _("{STR_VAR_1} starrt aufs\nMeer.");
static const u8 sCondMsg34[] = _("Dein Pokémon starrt gebannt\naufs Meer!");
...
static const u8 sCondMsg36[] = _("{STR_VAR_1} lauscht dem Klang\ndes Wasserfalls.");
static const u8 sCondMsg37[] = _("{STR_VAR_1} freut sich\nüber den Regen!");
static const u8 sCondMsg38[] = _("{STR_VAR_1} betrachtet seine\nSpiegelung im Wasser.");
static const u8 sCondMsg39[] = _("{STR_VAR_1} entspannt sich\nbeim Rascheln der Blätter…");
...
static const u8 sCondMsg42[] = _("{STR_VAR_1}s Verbrennung\nsieht schmerzhaft aus!");
static const u8 sCondMsg43[] = _("{STR_VAR_1} freut sich,\nendlich draußen zu sein!");
static const u8 sCondMsg44[] = _("{STR_VAR_1} schaut zum\nHimmel hinauf.");
static const u8* const sDayTexts[] = {sCondMsg43, sCondMsg44, NULL};
static const u8 sCondMsg45[] = _("Dein Pokémon starrt gebannt\nin den Nachthimmel!");
static const u8 sCondMsg46[] = _("Dein Pokémon blickt fröhlich\nzum Sternenhimmel!");
static const u8* const sNightTexts[] = {sCondMsg45, sCondMsg46, NULL};
static const u8 sCondMsg50[] = _("{STR_VAR_1} ist beunruhigt\nvom abnormalen Wetter!");
