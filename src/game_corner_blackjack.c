...
static const u8 sText_YouLose[] = _("Du verlierst!");
static const u8 sText_YouWin[] = _("Du gewinnst!");
static const u8 sText_Push[] = _("Patt!");
static const u8 sText_BlackJack[] = _("Blackjack!");
static const u8 sText_Betting[] = _("Dein Einsatz:\n¥{STR_VAR_1}.");
static const u8 sText_NoBetting[] = _("Dein Einsatz:\n¥0.");
static const u8 sText_NoCoins[] = _("Du hast nicht\ngenug Münzen.");
static const u8 sHelpBarHitStandText[] = _("{DPAD_UPDOWN}Wählen  {A_BUTTON}Bestätigen  {B_BUTTON}Ende");
