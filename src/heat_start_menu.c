...
// --BG-GFX--
static const u32 sStartMenuTiles[] = INCGFX_U32("graphics/heat_start_menu/bg.png", ".4bpp.lz");
static const u32 sStartMenuTilemap[] = INCGFX_U32("graphics/heat_start_menu/bg.bin", ".lz");
static const u32 sStartMenuTilemapSafari[] = INCGFX_U32("graphics/heat_start_menu/bg_safari.bin", ".lz");
static const u16 sStartMenuPalette[] = INCGFX_U16("graphics/heat_start_menu/bg.pal", ".gbapal");
// gStandardMenuPalette is defined in menu.c

// --alternate BG pals--
static const u16 sStartMenuPalettes[MENU_PAL_COUNT][16] = {
    INCGFX_U16("graphics/heat_start_menu/bg.pal", ".gbapal"),
    INCGFX_U16("graphics/heat_start_menu/bg1.pal", ".gbapal"),
    INCGFX_U16("graphics/heat_start_menu/bg2.pal", ".gbapal"),
    INCGFX_U16("graphics/heat_start_menu/bg3.pal", ".gbapal"),
    INCGFX_U16("graphics/heat_start_menu/bg4.pal", ".gbapal"),
    INCGFX_U16("graphics/heat_start_menu/bg5.pal", ".gbapal"),
    INCGFX_U16("graphics/heat_start_menu/bg6.pal", ".gbapal"),
    INCGFX_U16("graphics/heat_start_menu/bg7.pal", ".gbapal"),
    INCGFX_U16("graphics/heat_start_menu/bg8.pal", ".gbapal"),
    INCGFX_U16("graphics/heat_start_menu/bg9.pal", ".gbapal"),
    INCGFX_U16("graphics/heat_start_menu/bg10.pal", ".gbapal"),
};
...
void ReloadHeatStartMenuPalette(void)
{
...
static const u32 sIconGfx[] = INCGFX_U32("graphics/heat_start_menu/icons.png", ".4bpp.lz");
static const u16 sIconPal[] = INCGFX_U16("graphics/heat_start_menu/icons.pal", ".gbapal");
...
static void Task_HeatStartMenu_HandleMainInput(u8 taskId) {
  ...
  if (JOY_NEW(A_BUTTON)) {
    ...
    PlaySE(SE_SELECT);
    if (gSaveBlock2Ptr->optionsStartMenuPalette > 0)
      gSaveBlock2Ptr->optionsStartMenuPalette--;
    else
      gSaveBlock2Ptr->optionsStartMenuPalette = MENU_PAL_COUNT - 1;
    ReloadHeatStartMenuPalette();
  } else if (JOY_NEW(R_BUTTON) && sHeatStartMenu->loadState == 0) {
    PlaySE(SE_SELECT);
    if (gSaveBlock2Ptr->optionsStartMenuPalette < MENU_PAL_COUNT - 1)
      gSaveBlock2Ptr->optionsStartMenuPalette++;
    else
