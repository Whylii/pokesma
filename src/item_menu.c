...
enum {
    ...
    ACTION_BY_AMOUNT,
    ACTION_BY_INDEX,
    ACTION_SELECT_BUTTON,   // tx_registered_items
    ACTION_OLD_TECHNIQUE,   // Variable Rod
...
static void ItemMenu_UseOutOfBattle_VariableOldRod(u8); // Variable Rod
...
static const u8 sText_NothingToSort[] = _("Bereits sortiert!");
static const u8 sMenuText_Select[] = _("Wählen");
static const struct MenuAction sItemMenuActions[] = {
    ...
    [ACTION_DESELECT]          = {COMPOUND_STRING("Abwählen"),  {ItemMenu_Deselect}},
    [ACTION_CHECK_TAG]         = {COMPOUND_STRING("Etikett prüfen"), {ItemMenu_CheckTag}},
    ...
    [ACTION_BY_TYPE]           = {COMPOUND_STRING("Typ"),       {ItemMenu_SortByType}},
    [ACTION_BY_AMOUNT]         = {COMPOUND_STRING("Anzahl"),    {ItemMenu_SortByAmount}},
    [ACTION_BY_INDEX]          = {COMPOUND_STRING("Index"),     {ItemMenu_SortByIndex}},
    [ACTION_OLD_TECHNIQUE]     = {sMenuText_OldTech,            {ItemMenu_UseOutOfBattle_VariableOldRod}},    //Variable Rod
    ...
    default:
        ...
        else
        {
            ...
            case POCKET_KEY_ITEMS:
                ...
                //Variable Rod
                if (gSpecialVar_ItemId == ITEM_OLD_ROD)
                {
...
static void ItemMenu_UseOutOfBattle_VariableOldRod(u8 taskId)   //Variable Rod
{
...
static void Task_WallyTutorialBagMenu(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        case WALLY_BAG_DELAY * 2:
            PlaySE(SE_SELECT);
            /* Move one more pocket to the right to reach the Poké Balls pocket. */
            SwitchBagPocket(taskId, MENU_CURSOR_DELTA_RIGHT, FALSE);
            tTimer++;
            break;
...
static void UNUSED ItemMenu_Deselect(u8 taskId)
{
    ...
    u16 itemId = gBagPockets[gBagPosition.pocket].itemSlots[listPosition].itemId;
