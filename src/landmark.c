...
static const struct Landmark Landmark_MrBrineysCottage = {COMPOUND_STRING("Brinys Hütte"), FLAG_LANDMARK_MR_BRINEY_HOUSE};
static const struct Landmark Landmark_AbandonedShip = {COMPOUND_STRING("Geisterschiff"), FLAG_LANDMARK_ABANDONED_SHIP};
static const struct Landmark Landmark_SeashoreHouse = {COMPOUND_STRING("Strandhaus"), FLAG_LANDMARK_SEASHORE_HOUSE};
static const struct Landmark Landmark_SlateportBeach = {COMPOUND_STRING("Granithafen Strand"), -1};
static const struct Landmark Landmark_CyclingRoad = {COMPOUND_STRING("Radrennweg"), -1};
...
static const struct Landmark Landmark_OldLadysRestShop = {COMPOUND_STRING("Rasthaus der alten Dame"), FLAG_LANDMARK_OLD_LADY_REST_SHOP};
static const struct Landmark Landmark_Desert = {COMPOUND_STRING("Wüste"), -1};
static const struct Landmark Landmark_WinstrateFamily = {COMPOUND_STRING("Familie Gewinner"), FLAG_LANDMARK_WINSTRATE_FAMILY};
...
static const struct Landmark Landmark_RusturfTunnel = {COMPOUND_STRING("Rostfurtunnel"), -1};
static const struct Landmark Landmark_PokemonDayCare = {COMPOUND_STRING("Pokémon-Pension"), FLAG_LANDMARK_POKEMON_DAYCARE};
static const struct Landmark Landmark_SafariZoneEntrance = {COMPOUND_STRING("Eingang Safarizone"), -1};
static const struct Landmark Landmark_MtPyre = {COMPOUND_STRING("Pyroberg"), -1};
static const struct Landmark Landmark_ShoalCave = {COMPOUND_STRING("Niedrigwasserhöhle"), -1};
...
static const struct Landmark Landmark_JaggedPass = {COMPOUND_STRING("Zackenpass"), -1};
static const struct Landmark Landmark_BerryMastersHouse = {COMPOUND_STRING("Haus des Beerenmeisters"), FLAG_LANDMARK_BERRY_MASTERS_HOUSE};
...
static const struct Landmark Landmark_ScorchedSlab = {COMPOUND_STRING("Hitzefelsen"), FLAG_LANDMARK_SCORCHED_SLAB};
static const struct Landmark Landmark_AncientTomb = {COMPOUND_STRING("Altes Grab"), FLAG_LANDMARK_ANCIENT_TOMB};
static const struct Landmark Landmark_SealedChamber = {COMPOUND_STRING("Versiegelte Kammer"), FLAG_LANDMARK_SEALED_CHAMBER};
static const struct Landmark Landmark_FossilManiacsHouse = {COMPOUND_STRING("Haus des Fossilfanatikers"), FLAG_LANDMARK_FOSSIL_MANIACS_HOUSE};
static const struct Landmark Landmark_HuntersHouse = {COMPOUND_STRING("Haus des Jägers"), FLAG_LANDMARK_HUNTERS_HOUSE};
static const struct Landmark Landmark_SkyPillar = {COMPOUND_STRING("Himmelssäule"), FLAG_LANDMARK_SKY_PILLAR};
static const struct Landmark Landmark_MirageTower = {COMPOUND_STRING("Luftspiegelungsturm"), FLAG_LANDMARK_MIRAGE_TOWER};
static const struct Landmark Landmark_AlteringCave = {COMPOUND_STRING("Wunderhöhle"), FLAG_LANDMARK_ALTERING_CAVE};
static const struct Landmark Landmark_DesertUnderpass = {COMPOUND_STRING("Wüstenunterführung"), FLAG_LANDMARK_DESERT_UNDERPASS};
