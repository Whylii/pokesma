...
static const u8 sText_PyramidFloor1[] = _("Pyramide 1. Stock");
static const u8 sText_PyramidFloor2[] = _("Pyramide 2. Stock");
static const u8 sText_PyramidFloor3[] = _("Pyramide 3. Stock");
static const u8 sText_PyramidFloor4[] = _("Pyramide 4. Stock");
static const u8 sText_PyramidFloor5[] = _("Pyramide 5. Stock");
static const u8 sText_PyramidFloor6[] = _("Pyramide 6. Stock");
static const u8 sText_PyramidFloor7[] = _("Pyramide 7. Stock");
