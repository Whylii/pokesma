...
static const u8 gText_Option[]             = _("{COLOR DARK_GRAY}Optionen");
static const u8 gText_TextSpeedSlow[]      = _("{COLOR DARK_GREY}{SHADOW LIGHT_GREEN}Langsam");
static const u8 gText_TextSpeedMid[]       = _("{COLOR DARK_GREY}Medium");
static const u8 gText_TextSpeedFast[]      = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Schnell");
static const u8 gText_BattleSceneOn[]      = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}An");
static const u8 gText_BattleSceneOff[]     = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Aus");
static const u8 gText_BattleStyleShift[]   = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Wechsel");
static const u8 gText_BattleStyleSet[]     = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Folge");
...
static const u8 gText_FrameType[]          = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Typ");
static const u8 gText_FrameTypeNumber[]    = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}");
static const u8 gText_ButtonTypeNormal[]   = _("{COLOR GREEN}Normal");
static const u8 gText_ButtonTypeLR[]       = _("{COLOR GREEN}LR");
...
{
    [MENUITEM_TEXTSPEED]   = COMPOUND_STRING("{COLOR BLUE}Text-Tempo"),
    [MENUITEM_BATTLESCENE] = COMPOUND_STRING("{COLOR DARK_GREY}Animationen"),
