...
static const u8 sText_WithdrawItem[] = _("Items mitnehmen");
static const u8 sText_DepositItem[] = _("Items ablegen");
static const u8 sText_TossItem[] = _("Items wegwerfen");
static const u8 sText_Mailbox[] = _("Briefkasten");

static const u8 sText_WithdrawHowManyItems[] = _("Wie viele {STR_VAR_1}\nmitnehmen?");
static const u8 sText_WithdrawXItems[] = _("{STR_VAR_2} {STR_VAR_1} mitgenommen.");
static const u8 sText_NoRoomInBag[] = _("Kein Platz mehr im Beutel.");
static const u8 sText_TooImportantToToss[] = _("Das ist zu wichtig\num es wegzuwerfen!");

static const u8 *const sItemStorage_OptionDescriptions[] =
{
    [MENU_WITHDRAW] = COMPOUND_STRING("Items aus dem PC mitnehmen."),
    [MENU_DEPOSIT]  = COMPOUND_STRING("Items in den PC einlagern."),
    [MENU_TOSS]     = COMPOUND_STRING("Gelagerte Items im PC wegwerfen."),
    [MENU_EXIT]     = gText_GoBackPrevMenu,
};

static const struct MenuAction sPlayerPCMenuActions[] =
{
    [MENU_ITEMSTORAGE] = { COMPOUND_STRING("{PLAYER}s PC"), {PlayerPC_ItemStorage} },
    [MENU_MAILBOX]     = { sText_Mailbox,                   {PlayerPC_Mailbox} },
    [MENU_DECORATION]  = { COMPOUND_STRING("Dekorationen"),   {PlayerPC_Decoration} },
...
const struct MenuAction gMailboxMailOptions[] =
{
    ...
    { COMPOUND_STRING("In den Beutel"), {Mailbox_MoveToBag} },
