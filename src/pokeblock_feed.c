...
static const u8 sText_Var1AteTheVar2[] = _("{STR_VAR_1} hat\n{STR_VAR_2} gegessen.{PAUSE_UNTIL_PRESS}");
static const u8 sText_Var1HappilyAteVar2[] = _("{STR_VAR_1} hat glücklich\n{STR_VAR_2} gegessen.{PAUSE_UNTIL_PRESS}");
static const u8 sText_Var1DisdainfullyAteVar2[] = _("{STR_VAR_1} hat ungern\n{STR_VAR_2} gegessen.{PAUSE_UNTIL_PRESS}");
