...
static const u8 sText_Stats_Buttons[] = _("{A_BUTTON}Wechseln   {DPAD_UPDOWN}Attacken");
static const u8 sText_Stats_Buttons_Decapped[] = _("{A_BUTTON}Wechseln   {DPAD_UPDOWN}Attacken");
static const u8 sText_Stats_HP[] = _("KP");
static const u8 sText_Stats_Attack[] = _("Angr");
static const u8 sText_Stats_Defense[] = _("Vert");
static const u8 sText_Stats_Speed[] = _("Init");
static const u8 sText_Stats_SpAttack[] = _("Sp.Angr.");
static const u8 sText_Stats_SpDefense[] = _("Sp.Vert.");
...
static const u8 sText_Stats_CatchRate_Legend[] = _("Legende");
static const u8 sText_Stats_CatchRate_VeryHard[] = _("Sehr schwer");
static const u8 sText_Stats_CatchRate_Difficult[] = _("Schwierig");
static const u8 sText_Stats_CatchRate_Medium[] = _("Mittel");
static const u8 sText_Stats_CatchRate_Relaxed[] = _("Locker");
static const u8 sText_Stats_CatchRate_Easy[] = _("Einfach");
static const u8 sText_Stats_ExpYield[] = _("EP-Ausbeute:");
static const u8 sText_Stats_EggCycles[] = _("Ei-Zyklen:");
...
static const u8 sText_Stats_MEDIUM_FAST[] = _("Mittelschnell");
static const u8 sText_Stats_ERRATIC[] = _("Erratisch");
static const u8 sText_Stats_FLUCTUATING[] = _("Schwankend");
static const u8 sText_Stats_MEDIUM_SLOW[] = _("Mittellangs.");
...
static const u8 sText_Stats_eggGroup[] = _("Ei-Gruppe 1:");
...
static const u8 sText_Stats_eggGroup_HUMAN_LIKE[] = _("Humanomorph");
...
static const u8 sText_EVO_PreEvo_PE_Mega[] = _("{STR_VAR_1} entwickelt sich mit\n{STR_VAR_2} zu Mega");
static const u8 sText_EVO_LEVEL_SILCOON[] = _("{LV}{UP_ARROW} zu {STR_VAR_2}, Schalokon-Art");
static const u8 sText_EVO_LEVEL_CASCOON[] = _("{LV}{UP_ARROW} zu {STR_VAR_2}, Panekon-Art");
...
static const u8 sText_EVO_CRITICAL_HITS[] = _("{STR_VAR_2} Volltreffer landen\nim Einzelkampf");
static const u8 sText_EVO_SCRIPT_TRIGGER_DMG[] = _("Nimmt mind. {STR_VAR_2} KP Schaden");
static const u8 sText_EVO_DARK_SCROLL[] = _("Finsternis-Schriftrolle");
static const u8 sText_EVO_WATER_SCROLL[] = _("Wasser-Schriftrolle");
static const u8 sText_EVO_USE_MOVE_TWENTY_TIMES[] = _("{LV}{UP_ARROW} nach 20x {STR_VAR_2}");
static const u8 sText_EVO_RECOIL_DAMAGE_MALE[] = _("{LV}{UP_ARROW} mit {STR_VAR_2} Rückstoß, ♂");
static const u8 sText_EVO_RECOIL_DAMAGE_FEMALE[] = _("{LV}{UP_ARROW} mit {STR_VAR_2} Rückstoß, ♀");
...
static const u8 sText_FORMS_Buttons_Decapped_PE[] = _("{A_BUTTON}Form-Modus  {START_BUTTON}Entw.");
static const u8 sText_FORMS_Buttons_Submenu_PE[] = _("{DPAD_NONE}FORMEN {A_BUTTON}PRÜFEN {START_BUTTON}Entw.");
static const u8 sText_FORMS_Buttons_Submenu_Decapped_PE[] = _("{DPAD_NONE}Formen {A_BUTTON}Prüfen {START_BUTTON}Entw.");
