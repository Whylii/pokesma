...
{
    [OPTION_WITHDRAW] = {COMPOUND_STRING("Pokémon mitnehmen"), COMPOUND_STRING("Move POKéMON stored in BOXES to\nyour party.")},
    [OPTION_DEPOSIT] = {COMPOUND_STRING("Pokémon ablegen"),  COMPOUND_STRING("Store POKéMON in your party in BOXES.")},
    [OPTION_MOVE_MONS] = {COMPOUND_STRING("Pokémon bewegen"),     COMPOUND_STRING("Organize the POKéMON in BOXES and\nin your party.")},
    [OPTION_MOVE_ITEMS] = {COMPOUND_STRING("Items bewegen"),       COMPOUND_STRING("Move items held by any POKéMON\nin a BOX or your party.")},
    [OPTION_EXIT] = {COMPOUND_STRING("Zurück!"),          COMPOUND_STRING("Return to the previous menu.")}
};
...
static const u8 gText_PkmnIsSelected[] = _("{DYNAMIC 0} ausgewählt.");
...
static const struct StorageMessage sMessages[] =
{
    ...
    [MSG_PICK_A_THEME] = {COMPOUND_STRING("Wähle ein Design."),       MSG_VAR_NONE},
    ...
    [MSG_BYE_BYE] = {COMPOUND_STRING("Lebe wohl, {DYNAMIC 0}!"),      MSG_VAR_RELEASE_MON_3},
    [MSG_MARK_POKE] = {COMPOUND_STRING("Markiere dein Pokémon."),         MSG_VAR_NONE},
    [MSG_LAST_POKE] = {COMPOUND_STRING("Dies ist dein letztes Pokémon!"),  MSG_VAR_NONE},
    [MSG_PARTY_FULL]           = {gText_YourPartysFull,                          MSG_VAR_NONE},
    [MSG_HOLDING_POKE] = {COMPOUND_STRING("Du hälst ein Pokémon!"),  MSG_VAR_NONE},
    [MSG_WHICH_ONE_WILL_TAKE] = {COMPOUND_STRING("Welches möchtest du?"),   MSG_VAR_NONE},
    [MSG_CANT_RELEASE_EGG] = {COMPOUND_STRING("Ein Ei kann nicht freigelassen werden."),  MSG_VAR_NONE},
    [MSG_CONTINUE_BOX] = {COMPOUND_STRING("Box-Vorgang fortsetzen?"),   MSG_VAR_NONE},
    [MSG_CAME_BACK] = {COMPOUND_STRING("{DYNAMIC 0} kehrte zurück!"),     MSG_VAR_MON_NAME_1},
    [MSG_WORRIED] = {COMPOUND_STRING("Hat es sich um dich gesorgt?"),  MSG_VAR_NONE},
    ...
    [MSG_PLACED_IN_BAG] = {COMPOUND_STRING("Item wurde im Beutel platziert."),    MSG_VAR_ITEM_NAME},
    [MSG_BAG_FULL] = {COMPOUND_STRING("Dein Beutel ist voll."),           MSG_VAR_NONE},
    [MSG_PUT_IN_BAG] = {COMPOUND_STRING("In den Beutel legen?"),  MSG_VAR_NONE},
    [MSG_ITEM_IS_HELD] = {COMPOUND_STRING("{DYNAMIC 0} wird jetzt gehalten."),   MSG_VAR_ITEM_NAME},
    [MSG_CHANGED_TO_ITEM] = {COMPOUND_STRING("Mit {DYNAMIC 0} getauscht."),    MSG_VAR_ITEM_NAME},
    [MSG_CANT_STORE_MAIL] = {COMPOUND_STRING("Der Brief kann nicht gelagert werden!"),      MSG_VAR_NONE},
};
...
static const u8 *const sMenuTexts[] =
{
    ...
    [MENU_WITHDRAW] = COMPOUND_STRING("Mitnehmen"),
    ...
    [MENU_SWITCH] = COMPOUND_STRING("Wechseln"),
