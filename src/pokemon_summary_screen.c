...
{
    [MOVE_RELEARNER_LEVEL_UP_MOVES] = COMPOUND_STRING("{START_BUTTON} Level-Up-Attacken"),
    [MOVE_RELEARNER_EGG_MOVES] =      COMPOUND_STRING("{START_BUTTON} Ei-Attacken"),
    [MOVE_RELEARNER_TM_MOVES] =       COMPOUND_STRING("{START_BUTTON} TM-Attacken"),
    [MOVE_RELEARNER_TUTOR_MOVES] =    COMPOUND_STRING("{START_BUTTON} Lehrer-Attacken"),
};
