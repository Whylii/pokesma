...
static const u8 *const sHelpBarTexts[HELPBAR_COUNT] =
{
    ...
    [HELPBAR_MAP_ZOOMED_IN]         = COMPOUND_STRING("{A_BUTTON}Voll {B_BUTTON}Zurück"),
    [HELPBAR_MAP_ZOOMED_OUT_CANFLY] = COMPOUND_STRING("{A_BUTTON}Zoom {B_BUTTON}Zurück {R_BUTTON}Fliegen"),
    [HELPBAR_MAP_ZOOMED_IN_CANFLY]  = COMPOUND_STRING("{A_BUTTON}Voll {B_BUTTON}Zurück {R_BUTTON}Fliegen"),
    [HELPBAR_CONDITION_MON_LIST]    = COMPOUND_STRING("{A_BUTTON}Befinden {B_BUTTON}Zurück"),
    [HELPBAR_CONDITION_MON_STATUS]  = COMPOUND_STRING("{A_BUTTON}Markierungen {B_BUTTON}Zurück"),
    [HELPBAR_CONDITION_MARKINGS]    = COMPOUND_STRING("{A_BUTTON}Markieren {B_BUTTON}Zurück"),
    [HELPBAR_MC_TRAINER_LIST]       = COMPOUND_STRING("{A_BUTTON}Menü {B_BUTTON}Zurück"),
    [HELPBAR_MC_CALL_MENU]          = COMPOUND_STRING("{A_BUTTON}OK {B_BUTTON}Zurück"),
