...
static const struct MatchCallCheckPageOverride sCheckPageOverrides[] = {
    {
        ...
        .flavorTexts = {
            ...
            [CHECK_PAGE_INTRO_1]  = COMPOUND_STRING("Ich würde einen Wasserfall"),
            [CHECK_PAGE_INTRO_2]  = COMPOUND_STRING("besteigen für seltene Steine!")
        }
    },
    {
        .idx = MC_HEADER_STEVEN,
        ...
        .flavorTexts = {
            [CHECK_PAGE_STRATEGY] = gText_MatchCallSteven_Strategy,
            [CHECK_PAGE_POKEMON]  = gText_MatchCallSteven_Pokemon,
            [CHECK_PAGE_INTRO_1]  = COMPOUND_STRING("Ich bin der Stärkste"),
            [CHECK_PAGE_INTRO_2]  = COMPOUND_STRING("von allen!")
        }
    },
    {
