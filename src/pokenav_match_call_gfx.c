...
static const u8 gText_NumberRegistered[] = _("Nummer registriert");
static const u8 gText_NumberOfBattles[] = _("Anzahl Kämpfe");
static const u8 gText_TrainerCloseBy[] = _("Dieser Trainer ist in der Umgebung\nund möchte ein Gespäch!");
