...
static const u8 Roulette_Text_PlayMinimumWagerIsX[] = _("Der Mindesteinsatz an diesem Tisch\nbeträgt {STR_VAR_1}. Möchtest du spielen?");
static const u8 Roulette_Text_NotEnoughCoins[] = _("Du hast nicht genug Münzen.");
static const u8 Roulette_Text_SpecialRateTable[] = _("Spezialtabelle jetzt aktiv!");
static const u8 Roulette_Text_ControlsInstruction[] = _("Wette mit dem + Steuerkreuz\nund drücke den A-Knopf.");
static const u8 Roulette_Text_ItsAHit[] = _("Treffer!");
static const u8 Roulette_Text_Jackpot[] = _("Hauptgewinn!");
static const u8 Roulette_Text_NothingDoing[] = _("Nichts zu machen!");
static const u8 Roulette_Text_YouveWonXCoins[] = _("Du hast {STR_VAR_1} Münzen gewonnen!");
static const u8 Roulette_Text_NoCoinsLeft[] = _("Keine Münzen mehr…");
static const u8 Roulette_Text_KeepPlaying[] = _("Weiterspielen?");
static const u8 Roulette_Text_BoardWillBeCleared[] = _("Das Roulettebrett wird gelöscht.");
static const u8 Roulette_Text_CoinCaseIsFull[] = _("Dein Münzfach ist voll!\nMünzen können gegen Preise getauscht werden.");
