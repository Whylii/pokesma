...
static const u8 sText_YouveGot9999Coins[] = _("Du hast 9,999 Münzen.");
static const u8 sText_YouveRunOutOfCoins[] = _("Keine Münzen mehr.\nGame over!");
static const u8 sText_YouDontHaveThreeCoins[] = _("Du hast keine 3 Münzen.");
static const u8 sText_ReelTimeHelp[] = _("Reel Time\nDeine Chance für einen\nBonusgewinn!");
