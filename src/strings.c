...
ALIGNED(4) const u8 gText_PickNextCancel[] = _("{DPAD_UPDOWN}Info{A_BUTTON}Weiter {B_BUTTON}Zurück.");
...
const u8 gText_HOFDexRating[] = _("Gesehene Pokémon: {STR_VAR_1}!\nGefangene Pokémon: {STR_VAR_2}!\pProf. Birk's Meinung!\pProf. Birk: Lass mich mal sehen…\p");
...
const u8 gText_LureEffectsLingered[] = _("ber die Wirkung eines Lockstoffes\n ist von früher noch vorhanden.{PAUSE_UNTIL_PRESS}");
...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [POCKET_BATTLE_ITEMS] = COMPOUND_STRING("Kampfitems"),
    [POCKET_BERRIES] = COMPOUND_STRING("Beeren"),
    [POCKET_LETTERS] = COMPOUND_STRING("Briefe"),
...
const u8 gText_CanIHelpWithAnythingElse[] = _("Gibt es noch etwas, womit\nich dienen kann?");
...
const u8 gText_12PoofForgotMove[] = _("1, {PAUSE 5}2 und{PAUSE 5}… {PAUSE 5}… {PAUSE 5}… {PAUSE 5}{PLAY_SE SE_BALL_BOUNCE_1} Schwupp!\p{STR_VAR_1} hat\n{STR_VAR_2} vergessen.\pUnd…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnTransformed[] = _("{STR_VAR_1} transformierte sich!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ChoosePokemonCancel[] = _("Wähle Pokémon oder Zurück.");
const u8 gText_ChoosePokemonConfirm[] = _("Wähle ein Pokémon.");
...
const u8 gText_Learned[] = _("Kennt Attacke.");
...
const u8 gText_XNatureMetAtYZ[] = _("Wesen: {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}\n{DYNAMIC 5}\nFundort: {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}\nGetroffen mit {LV_2}{DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1}");
const u8 gText_XNatureHatchedAtYZ[] = _("Wesen: {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}\n{DYNAMIC 5}\nFundort: {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}\nGeschlüpft mit {LV_2}{DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1}");
const u8 gText_XNatureObtainedInTrade[] = _("Wesen: {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}\n{DYNAMIC 5}\nin einem Tausch erhalten.");
const u8 gText_XNatureFatefulEncounter[] = _("Wesen: {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}\n{DYNAMIC 5}\nin schicksalhafter Begeg-\nnung mit {LV_2}{DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1} erhalten.");
const u8 gText_XNatureProbablyMetAt[] = _("Wesen: {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}\n{DYNAMIC 5}\nFundort: {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}\nvermutlich mit {LV_2}{DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1}");
const u8 gText_XNature[] = _("Wesen: {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}\n{DYNAMIC 5}");
const u8 gText_XNatureMetSomewhereAt[] = _("Wesen: {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}\n{DYNAMIC 5}\nirgendwo getroffen\nmit {LV_2}{DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1}");
const u8 gText_XNatureHatchedSomewhereAt[] = _("Wesen: {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}\n{DYNAMIC 5}\nIrgendwo\ngeschlüpft mit {LV_2}{DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1}");
...
const u8 gText_DelRegist[] = _("Eintrag löschen");
...
const u8 gText_MustBePlacedOnDesk[] = _("Kann hier nicht platziert\nwerden."); // Unused
...
const u8 gText_AndMakeAMessage2[] = _("um einen Satz zu bilden.");
...
const u8 gText_TheMailSalutation[] = _("Der Brief-Gruß"); // Unused
...
const u8 gText_PokeblocksWithFriends[] = _("Pokériegel mit Freund/en:");
...
const u8 gText_UnusedCancel[] = _("Abbruch"); // Unused
...
const u8 gText_10P30P50P50P[] = _("{CLEAR_TO 3}10Pkt.{CLEAR_TO 43}30Pkt.{CLEAR_TO 83}50Pkt.{CLEAR_TO 119}{EMOJI_MINUS}50Pkt.");
...
const u8 gText_FilledStorageSpace2[] = _("Der Lagerplatz wurde aufgebraucht.");
...
const u8 gText_Record[] = _("Sichern");
...
const u8 gText_TimesCleared[] = _("Erf. Teilnahmen: {CLEAR 5}{STR_VAR_1}");
...
const u8 gText_FrontierFacilityTotalCaughtSpeciesBanned[] = _(" und {STR_VAR_2} der Pokémon-Spezies\nsind nicht kompatibel");
const u8 gText_FrontierFacilityIncluding[] = _(".\pDiese beinhalten");
const u8 gText_FrontierFacilityAreInelegible[] = _(" nicht kompatibel");
...
const u8 gText_TheseThreePkmnOkay[] = _("Diese drei Pokémon auswählen?");
...
const u8 gText_PkmnForSwap[] = _("Wechsel-Pokémon");
const u8 gText_Cancel3[] = _("Abbruch");
const u8 gText_Swap2[] = _("WECHSEL"); // Unused
...
ALIGNED(4) const u8 gText_Exit3[] = _("Beenden");
...
const u8 gText_WinLoseDraw[] = _("{CLEAR_TO 83}Siege{CLEAR_TO 128}Niederl.{CLEAR_TO 176}Patt");
...
const u8 gText_Exit4[] = _("Beenden");
...
const u8 gText_MoveRelearnerTeachMoveConfirmUseTm[] = _("{STR_VAR_2} beibringen?");
...
const u8 gText_MoveRelearnerAndPoof[] = _("{PAUSE 5}1, {PAUSE 5}2 {PAUSE 5}…{PAUSE 5}…{PAUSE 5}… {PAUSE 5}{PLAY_SE SE_BALL_BOUNCE_1}Schwupp!\p");
const u8 gText_MoveRelearnerPkmnForgotMoveAndLearnedNew[] = _("{STR_VAR_1} vergaß\n{STR_VAR_3}.\pUnd…\p{STR_VAR_1} lernt {STR_VAR_2}.");
const u8 gText_MoveRelearnedPkmnDidNotLearnMove[] = _("{STR_VAR_1} hat {STR_VAR_2}\n nicht erlernt."); // Unused
const u8 gText_MoveRelearnerGiveUp[] = _("Soll {STR_VAR_1} keine neue\nAttacke erlernen?");
const u8 gText_MoveRelearnerStop[] = _("{STR_VAR_1} keine weiteren\nAttacken beibringen?");;
...
const u8 gText_Cancel4[] = _("Abbruch");
