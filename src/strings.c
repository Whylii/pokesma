...
const u8 gText_ExpShareOn[] = _("Der Exp.-Teiler wurde aktiviert.{PAUSE_UNTIL_PRESS}");
const u8 gText_ExpShareOff[] = _("Der Exp.-Teiler wurde deaktiviert.{PAUSE_UNTIL_PRESS}");
const u8 gText_SmallDot[] = _("·");
const u8 gText_LargeDot[] = _("{EMOJI_CIRCLE}");
const u8 gText_PageNav[] = _("{L_BUTTON}{R_BUTTON} Seite");
const u8 gText_MenuPal[] = _("Startmenü-Farbe");
const u8 gText_MenuPalColor[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Typ ");
